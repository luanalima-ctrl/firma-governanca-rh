...
def renderizar_resultado_comportamental(
    ...
    if narrativa:
        ...
        # "Regenerar Laudo com IA" logo abaixo.
        st.divider()
    ...
    if colaborador_id:
        st.divider()
        if st.button("Regenerar Laudo com IA", key=f"regenerar_laudo_{colaborador_id}"):
            with st.spinner("Gerando uma nova leitura do perfil..."):
            ...
            st.success("Laudo atualizado.")
            st.rerun()

        # Diagnóstico temporário: mostra o motivo real de ter caído no
        # fallback offline na última tentativa de gerar/regenerar o laudo
