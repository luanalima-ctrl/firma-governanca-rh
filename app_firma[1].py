...
# ---------------------------------------------------------------------------
# Gatilho financeiro (Nota Consolidada do Período)
# ---------------------------------------------------------------------------
...
Consolidada do Período é MENOR que a nota mínima de elegibilidade (NOTA_MINIMA_ELEGIVEL).
...
def gerar_pdf_pdi(
    ...
    if not achados:
        story.append(Paragraph(
            ...
            "consolidada do período ficou abaixo da nota mínima de elegibilidade. Recomenda-se revisão geral com o "
...
(st.session_state). Implementa:
  ...
  • Motor do gatilho financeiro (nota consolidada ≥ NOTA_MINIMA_ELEGIVEL, hoje em 4.0 = 80%)
  • Elegibilidade a promoção (1 ano de empresa + 6 meses de interstício +
    janelas de Junho/Dezembro)
  • Gerador automático de PDI em PDF quando a nota cai abaixo do gatilho de elegibilidade
...
with abas[5]:
    ...
    st.caption(
        ...
        f"abaixo do gatilho de {NOTA_MINIMA_ELEGIVEL} ({NOTA_MINIMA_ELEGIVEL/5*100:.0f}%)."
    )
