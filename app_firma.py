        ...
        if not colabs:
            ...
            if not periodos_disponiveis:
                ...
                if papel == "COLABORADOR" and not resultado["elegivel"]:
                    ...
                    compilado_proprio = montar_compilado_mensal(ficha_mensal, campo_periodo)
                    if st.button("Gerar meu PDI em PDF"):
                        with st.spinner("Consolidando o mês e gerando o relatório..."):
                            perfil_proprio_pdi = obter_perfil_comportamental(colaborador_id)
                            plano_proprio = gerar_plano_desenvolvimento_mensal(periodo_sel, ficha_mensal, compilado_proprio, perfil_proprio_pdi, colaborador["nome"], colaborador["cargo"])
                            ...
                            gerar_pdf_pdi(caminho_proprio, colaborador["nome"], colaborador["cargo"], periodo_sel, resultado["nota_final"], compilado_proprio, ficha_mensal, plano_proprio)
        ...
        if not colabs:
            ...
            if not periodos_disponiveis:
                ...
                if resultado["elegivel"]:
                    ...
                    if st.button("Gerar PDI Corporativo", type="primary"):
                        nome_arquivo = f"PDI_{colaborador['nome'].replace(' ', '_')}_{periodo_sel}.pdf"
                        caminho = os.path.join(PASTA_PDIS, nome_arquivo)
                        with st.spinner("Consolidando o mês inteiro e gerando o relatório..."):
                            ...
                            gerar_pdf_pdi(caminho, colaborador["nome"], colaborador["cargo"], periodo_sel, resultado["nota_final"], compilado, ficha_mensal, plano)
