...
st.markdown(
    ...
    button[kind="secondaryFormSubmit"] {
        ...
        color: #FFFFFF !important;
        border: 1px solid #E12E2E !important;
        text-transform: uppercase;
        font-weight: 700;
        border-radius: 4px;
    ...
    .stTabs [aria-selected="true"] {
        ...
        border-bottom-color: #E12E2E !important;
    }
    ...
    /* Caixas de seleção (selectbox/multiselect) — componentes BaseWeb, não
       são <select> nativos, então precisam de seletores próprios. */
    ...
    /* Menus/dropdowns e calendário (date input) do BaseWeb costumam ser
       renderizados fora da árvore principal do app (num portal), então
       precisam de regras próprias de alto contraste. */
    ...
    /* Rádio e checkbox: rótulos precisam ficar brancos explicitamente */
