...
# ---------------------------------------------------------------------------
# Perguntas específicas por cargo/nível (substitui o gabarito genérico acima
# sempre que a área/cargo tiver conteúdo próprio cadastrado). Estrutura:
# ITENS_CAMPO_POR_CARGO[area][cargo_label] = {"item1": {"titulo","pergunta",
# "considerar"}, ..., "item5": {...}}
# ---------------------------------------------------------------------------

ITENS_CAMPO_POR_CARGO = {
  "LED": {
    "Auxiliar de LED I": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Cumpriu o horário e realizou o descarregamento, movimentação dos cases e separação dos módulos, cabos e acessórios necessários para o início da montagem?",
        "considerar": "pontualidade, agilidade na movimentação e preparação dos materiais sem gerar atraso para a equipe."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Realizou o encaixe e travamento dos módulos de LED conforme orientação, mantendo o painel firme e corretamente alinhado?",
        "considerar": "encaixe correto, travamento, alinhamento dos módulos e ausência de erros que gerem retrabalho."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manuseou os módulos, lentes, máscaras, cabos e acessórios com cuidado e manteve os materiais organizados durante a montagem e desmontagem?",
        "considerar": "prevenção de impactos e danos, organização da área, acondicionamento dos equipamentos e manutenção das rotas de circulação livres."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Ao identificar um módulo, cabo ou conexão com problema, comunicou rapidamente o responsável técnico e seguiu o procedimento indicado para a correção?",
        "considerar": "atenção às falhas, comunicação rápida e respeito aos limites da função."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Manteve postura profissional e discreta durante o evento, respeitando o cliente, a produção e a equipe?",
        "considerar": "uniforme, educação, discrição, uso adequado do celular, circulação nas áreas do evento e cumprimento das orientações da produção."
      }
    },
    "Auxiliar de LED II": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Antecipou a separação dos módulos, cabos e acessórios necessários para sua frente, garantindo que a montagem avançasse dentro do cronograma?",
        "considerar": "preparação antecipada, organização dos materiais e iniciativa para evitar esperas ou atrasos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou o encaixe, travamento e alinhamento dos módulos de LED com precisão, reduzindo erros e necessidade de retrabalho?",
        "considerar": "qualidade dos encaixes, firmeza, alinhamento do painel e domínio das atividades esperadas para o nível."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve os módulos, cabos, cases e acessórios organizados durante a operação e contribuiu para a conferência e acondicionamento dos equipamentos?",
        "considerar": "zelo pelo patrimônio, organização da frente, conferência dos materiais e prevenção de perdas ou danos."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou e corrigiu problemas simples de montagem, conexão ou cabeamento dentro de sua capacidade, acionando o responsável quando necessário?",
        "considerar": "identificação de falhas, iniciativa para correção e capacidade de reconhecer situações que precisam de apoio técnico."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Manteve postura profissional e discreta, comunicando-se adequadamente com a produção e respeitando o cliente durante o evento?",
        "considerar": "uniforme, educação, discrição, uso adequado do celular, cuidado ao circular nas áreas do cliente e prontidão para atender às orientações da produção."
      }
    },
    "Auxiliar de LED III": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Antecipou as necessidades de materiais e equipamentos da sua frente e garantiu que a equipe tivesse os recursos necessários para cumprir o cronograma de montagem?",
        "considerar": "planejamento, antecipação de necessidades, organização e capacidade de evitar paradas por falta de material."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou montagem, alinhamento e travamento dos módulos de LED com autonomia, precisão e dentro do padrão esperado para a entrega?",
        "considerar": "domínio da montagem, qualidade do painel, autonomia e baixa necessidade de correções ou acompanhamento."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle sobre os equipamentos e materiais da sua frente, garantindo organização, conferência e acondicionamento correto durante todo o evento?",
        "considerar": "zelo pelo patrimônio, controle dos materiais, organização dos cases e prevenção de perdas, danos ou extravios."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou rapidamente problemas de montagem, cabeamento ou módulos e contribuiu para a solução dentro de sua capacidade?",
        "considerar": "percepção de falhas, agilidade, iniciativa e capacidade de direcionar corretamente situações que ultrapassem sua responsabilidade."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Demonstrou postura profissional e serviu como referência para os demais auxiliares no relacionamento com a produção, cliente e equipe durante o evento?",
        "considerar": "apresentação pessoal, discrição, educação, comunicação, uso adequado do celular, respeito ao ambiente do cliente e exemplo de comportamento profissional."
      }
    },
    "Assistente de LED I": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Entregou o cabeamento de sinal e energia, as conexões básicas e os equipamentos da sua frente preparados dentro do prazo definido para a montagem e o ensaio técnico?",
        "considerar": "pontualidade, preparação dos materiais, execução das conexões e cumprimento dos horários."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou as conexões de sinal e energia e os testes básicos do sistema de LED conforme o padrão técnico orientado, evitando falhas ou retrabalho?",
        "considerar": "organização das conexões, identificação dos cabos, testes realizados e cumprimento do padrão técnico."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve a House, os cabos, processadoras, cases e demais equipamentos organizados e protegidos durante a montagem, operação e desmontagem?",
        "considerar": "organização, zelo pelo patrimônio, acondicionamento correto e cuidado com os equipamentos."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Ao identificar falhas simples, como módulo apagado, cabo com problema ou perda de sinal, identificou a causa e realizou a correção adequada ou acionou o responsável técnico?",
        "considerar": "percepção da falha, agilidade, procedimento correto e comunicação ao responsável quando necessário."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Manteve postura profissional e discreta na House, atendendo às orientações da produção e respeitando o cliente durante todo o evento?",
        "considerar": "uniforme, educação, discrição, comunicação, uso adequado do celular e comportamento no ambiente do cliente."
      }
    },
    "Assistente de LED II": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Antecipou a preparação do cabeamento de sinal e energia e das conexões da sua frente, garantindo que o sistema estivesse pronto para os testes e ensaio dentro do cronograma?",
        "considerar": "antecipação, organização, agilidade e capacidade de evitar atrasos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou e validou as conexões do sistema de LED, garantindo estabilidade de sinal, proporção correta da imagem e funcionamento adequado antes da liberação para o evento?",
        "considerar": "qualidade dos sinais, testes, estabilidade da imagem e identificação de falhas antes da operação."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle e organização dos cabos, processadoras, cases e equipamentos da sua frente durante toda a operação, evitando perdas, danos ou desorganização?",
        "considerar": "zelo, organização da House, identificação dos equipamentos e acondicionamento."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Diante de uma falha de sinal, módulo ou conexão, conseguiu identificar e corrigir problemas de baixa e média complexidade sem comprometer a operação?",
        "considerar": "diagnóstico, iniciativa, segurança na correção e capacidade de acionar o técnico quando necessário."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Manteve postura profissional e discreta durante a operação, comunicando-se adequadamente com produção, equipe e cliente e respondendo com agilidade às solicitações do evento?",
        "considerar": "comunicação, educação, discrição na House, prontidão, apresentação pessoal e comportamento diante do cliente."
      }
    },
    "Assistente de LED III": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Planejou e antecipou as necessidades de cabeamento, conexões e equipamentos da sua frente, garantindo a liberação do sistema dentro do cronograma do evento?",
        "considerar": "planejamento, antecipação, autonomia e capacidade de evitar paradas ou atrasos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou e validou o sistema de LED com autonomia, garantindo estabilidade de sinal, qualidade da imagem, proporção, brilho e funcionamento adequado para a operação?",
        "considerar": "domínio técnico, qualidade dos testes, identificação preventiva de falhas e baixa necessidade de acompanhamento."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle sobre os equipamentos e materiais da sua frente, garantindo organização da House, correta utilização dos cabos e acondicionamento dos equipamentos durante o evento?",
        "considerar": "controle do patrimônio, organização, zelo, conferência e prevenção de perdas ou danos."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou e solucionou com agilidade falhas de sinal, cabeamento ou módulos dentro de sua capacidade, direcionando corretamente problemas que exigiam atuação técnica?",
        "considerar": "diagnóstico, autonomia, agilidade, segurança na solução e capacidade de reconhecer limites técnicos."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Demonstrou postura profissional e serviu como referência para os demais assistentes na comunicação com a produção, equipe e cliente durante a operação?",
        "considerar": "liderança pelo exemplo, comunicação, discrição, apresentação pessoal, prontidão e comportamento no ambiente do cliente."
      }
    },
    "Técnico de LED I": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Preparou e validou o sistema de LED da sua frente, incluindo processamento, resolução, mapeamento, sinal e energia, garantindo a liberação dentro do cronograma do evento?",
        "considerar": "planejamento, organização, testes e cumprimento do horário de liberação."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Garantiu o funcionamento estável do sistema de LED, com imagem corretamente configurada, boa qualidade visual e ausência de falhas perceptíveis durante a operação?",
        "considerar": "estabilidade de sinal, proporção da imagem, brilho, configuração e qualidade visual."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve a House e os equipamentos da operação organizados, garantindo o correto uso, identificação, proteção e acondicionamento dos materiais durante o evento?",
        "considerar": "organização técnica, zelo pelo patrimônio, controle dos equipamentos e desmontagem."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou e solucionou com segurança as falhas técnicas ocorridas no sistema, utilizando os procedimentos e recursos disponíveis sem comprometer a operação?",
        "considerar": "diagnóstico, agilidade, segurança, tomada de decisão e comunicação da ocorrência."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Assumiu a responsabilidade técnica pela sua frente, mantendo comunicação clara com a produção e postura profissional e discreta diante do cliente?",
        "considerar": "responsabilidade, comunicação, liderança técnica, discrição e representação da Firma."
      }
    },
    "Técnico de LED II": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Planejou e coordenou a preparação técnica da sua frente, antecipando necessidades de processamento, resolução, mapeamento e sinal para garantir a liberação dentro do cronograma?",
        "considerar": "planejamento, antecipação de riscos, organização e cumprimento dos prazos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Validou a configuração final do sistema de LED, garantindo estabilidade de sinal, qualidade de imagem, calibração, brilho e compatibilidade com as necessidades de operação e transmissão?",
        "considerar": "qualidade técnica, calibração, estabilidade, testes e validação antes da operação."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle técnico e operacional sobre os equipamentos, cabos e recursos da sua frente, garantindo organização durante a operação e eficiência no desmonte?",
        "considerar": "controle do patrimônio, organização da House, conferência e acondicionamento."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Diante de uma intercorrência técnica, realizou o diagnóstico e conduziu a solução com agilidade, utilizando caminhos alternativos de sinal ou equipamentos de backup quando necessário?",
        "considerar": "capacidade de diagnóstico, redundância, tomada de decisão e controle durante situações de pressão."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Atuou as referência técnica da sua frente, mantendo comunicação objetiva com produção, equipe e cliente e conduzindo as demandas com segurança e profissionalismo?",
        "considerar": "liderança técnica, comunicação, postura, segurança nas decisões e relacionamento com o cliente."
      }
    },
    "Técnico de LED III": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Conduziu o planejamento técnico do sistema de LED, antecipando riscos e garantindo que processamento, resolução, mapeamento, sinal e redundâncias estivessem preparados para a entrega dentro do cronograma global?",
        "considerar": "visão antecipada, planejamento, gestão de riscos e cumprimento do cronograma."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Garantiu a qualidade técnica final do sistema de LED, validando estabilidade, calibração, cores, resolução, refresh e compatibilidade com operação, transmissão e conteúdo do cliente?",
        "considerar": "excelência técnica, validação final, estabilidade e qualidade visual."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Garantiu o controle e a preservação dos equipamentos da sua frente, mantendo organização técnica durante a operação e assegurando um desmonte eficiente e sem avarias?",
        "considerar": "gestão do patrimônio, organização, conferência, agilidade e segurança no desmonte."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Conduziu a solução de intercorrências críticas do sistema de LED com rapidez e segurança, utilizando redundâncias e tomando decisões técnicas que preservaram a continuidade do evento?",
        "considerar": "diagnóstico avançado, redundância, tomada de decisão sob pressão e proteção da entrega."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Atuou como principal referência técnica da frente, conduzindo a equipe e mantendo comunicação segura, profissional e discreta com produção e cliente durante todo o evento?",
        "considerar": "liderança, responsabilidade pela entrega, comunicação, postura diante do cliente e capacidade de conduzir a equipe."
      }
    }
  },
  "SOM": {
    "Auxiliar de Som I": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Cumpriu o horário e realizou o descarregamento, movimentação dos cases e separação dos cabos, caixas acústicas, pedestais e acessórios necessários para o início da montagem?",
        "considerar": "pontualidade, agilidade, preparação dos materiais e cumprimento do cronograma."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou a montagem e conexão dos equipamentos de áudio conforme orientação, mantendo os cabos, caixas e acessórios corretamente instalados e organizados?",
        "considerar": "conexão correta, organização dos cabos, posicionamento dos equipamentos e ausência de erros que gerem retrabalho."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manuseou caixas acústicas, microfones, cabos, cases e demais equipamentos com cuidado, mantendo a área de trabalho organizada durante a montagem e desmontagem?",
        "considerar": "zelo pelo patrimônio, prevenção de danos, organização da frente e acondicionamento dos equipamentos."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Ao identificar um cabo, equipamento ou conexão com problema, comunicou rapidamente o responsável técnico e seguiu o procedimento indicado para a correção?",
        "considerar": "atenção às falhas, comunicação rápida e respeito aos limites da função."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Manteve postura profissional e discreta durante o evento, respeitando o cliente, a produção e a equipe?",
        "considerar": "uniforme, educação, discrição, uso adequado do celular, circulação nas áreas do evento e cumprimento das orientações."
      }
    },
    "Auxiliar de Som II": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Antecipou a separação e preparação dos cabos, caixas, pedestais, microfones e acessórios necessários para sua frente, garantindo que a montagem avançasse dentro do cronograma?",
        "considerar": "preparação antecipada, organização, iniciativa e capacidade de evitar esperas ou atrasos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou a montagem, passagem e organização dos cabos e conexões de áudio com precisão, reduzindo erros e necessidade de retrabalho?",
        "considerar": "qualidade das conexões, identificação dos cabos, organização da montagem e domínio das atividades esperadas para o nível."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve os equipamentos, cabos, cases e acessórios organizados durante a operação e contribuiu para a conferência e acondicionamento dos equipamentos?",
        "considerar": "zelo pelo patrimônio, organização da frente, conferência dos materiais e prevenção de perdas ou danos."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou e corrigiu problemas simples de cabeamento, conexão ou montagem de áudio dentro de sua capacidade, acionando o responsável quando necessário?",
        "considerar": "identificação de falhas, iniciativa para correção e capacidade de reconhecer situações que precisam de apoio técnico."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Manteve postura profissional e discreta, comunicando-se adequadamente com a produção e respeitando o cliente durante o evento?",
        "considerar": "uniforme, educação, discrição, uso adequado do celular, cuidado ao circular nas áreas do cliente e prontidão para atender às orientações."
      }
    },
    "Auxiliar de Som III": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Antecipou as necessidades de equipamentos, cabos e acessórios da sua frente, garantindo que a equipe tivesse os recursos necessários para cumprir o cronograma de montagem?",
        "considerar": "planejamento, antecipação de necessidades, organização e capacidade de evitar paradas por falta de material."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou a montagem e organização do sistema de áudio com autonomia, precisão e dentro do padrão esperado para a entrega?",
        "considerar": "domínio da montagem, qualidade das conexões, organização dos cabos, posicionamento dos equipamentos e baixa necessidade de acompanhamento."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle sobre os equipamentos e materiais da sua frente, garantindo organização, conferência e acondicionamento correto durante todo o evento?",
      ...
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou rapidamente problemas de montagem, cabeamento ou equipamentos de áudio e contribuiu para a solução dentro de sua capacidade?",
        "considerar": "percepção de falhas, agilidade, iniciativa e capacidade de direcionar corretamente situações que ultrapassem sua responsabilidade."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
    ...
    "Assistente de Som I": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Entregou a passagem e organização dos cabos de áudio, conexões dos equipamentos e preparação da sua frente dentro do prazo definido para a montagem e o ensaio técnico?",
        "considerar": "pontualidade, preparação, organização dos cabos e cumprimento do cronograma."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou as conexões de áudio e os testes básicos do sistema conforme o padrão técnico orientado, garantindo que sua frente estivesse pronta para a operação?",
        "considerar": "conexões corretas, identificação dos cabos, testes realizados e ausência de falhas causadas por montagem incorreta."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve cabos, microfones, caixas, periféricos, cases e demais equipamentos organizados e protegidos durante a montagem, operação e desmontagem?",
        "considerar": "zelo pelo patrimônio, organização da House, acondicionamento e cuidado com os equipamentos."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Ao identificar falhas simples de áudio, cabeamento ou conexão, conseguiu realizar a correção adequada ou acionou rapidamente o responsável técnico?",
        "considerar": "percepção da falha, agilidade, procedimento correto e comunicação."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Manteve postura profissional e discreta durante o evento, atendendo às orientações da produção e respeitando o cliente?",
        "considerar": "uniforme, educação, discrição, comunicação, uso adequado do celular e comportamento no ambiente do cliente."
      }
    },
    "Assistente de Som II": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Antecipou a preparação dos cabos, conexões e equipamentos da sua frente, garantindo que o sistema estivesse pronto para os testes e ensaio dentro do cronograma?",
        "considerar": "anticipação, organização, iniciativa e capacidade de evitar atrasos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou e validou as conexões do sistema de áudio, garantindo sinal adequado, organização do cabeamento e funcionamento correto dos equipamentos da sua frente?",
        "considerar": "qualidade das conexões, testes, identificação de falhas e redução de retrabalho."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle e organização dos equipamentos, cabos e acessórios da sua frente durante toda a operação, evitando perdas, danos ou desorganização?",
        "considerar": "zelo pelo patrimônio, organização da House, conferência e acondicionamento."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Diante de uma falha de sinal, conexão ou equipamento, conseguiu identificar e corrigir problemas de baixa e média complexidade sem comprometer a operação?",
        "considerar": "diagnóstico, iniciativa, segurança na correção e capacidade de acionar o técnico quando necessário."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Manteve postura profissional e discreta durante a operação, comunicando-se adequadamente com produção, equipe e cliente e respondendo com agilidade às solicitações do evento?",
        "considerar": "comunicação, educação, discrição, prontidão e comportamento diante do cliente."
      }
    },
    "Assistente de Som III": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Planejou e antecipou as necessidades de equipamentos, cabos e conexões da sua frente, garantindo a preparação do sistema dentro do cronograma do evento?",
        "considerar": "planejamento, antecipação, autonomia e capacidade de evitar paradas ou atrasos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou e validou o sistema de áudio com autonomia, garantindo qualidade das conexões, estabilidade do sinal e funcionamento adequado dos equipamentos durante a operação?",
        "considerar": "domínio técnico, qualidade dos testes, identificação preventiva de falhas e baixa necessidade de acompanhamento."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle sobre os equipamentos e materiais da sua frente, garantindo organização, conferência e acondicionamento correto durante toda a operação?",
        "considerar": "controle do patrimônio, organização, zelo e prevenção de perdas ou danos."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou e solucionou com agilidade falhas de cabeamento, conexão ou equipamentos de áudio dentro de sua capacidade, direcionando corretamente os problemas que exigiam atuação técnica?",
        "considerar": "diagnóstico, autonomia, agilidade, segurança e capacidade de reconhecer limites técnicos."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Demonstrou postura profissional e serviu como referência para os demais assistentes na comunicação com a produção, equipe e cliente durante a operação?",
    ...
    "Técnico de Som I": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Preparou e validou o sistema de áudio da sua frente, incluindo cabeamento, conexões, posicionamento dos equipamentos e testes, garantindo a liberação dentro do cronograma do evento?",
        "considerar": "planejamento, organização, testes e cumprimento do horário de liberação."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Garantiu o funcionamento adequado do sistema de áudio, com sinal estável, conexões corretas e qualidade sonora compatível com a necessidade do evento?",
        "considerar": "qualidade do sinal, funcionamento dos equipamentos, testes e ausência de falhas decorrentes da montagem."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve a House e os equipamentos de áudio organizados, garantindo o correto uso, identificação, proteção e acondicionamento dos materiais durante o evento?",
        "considerar": "organização técnica, zelo pelo patrimônio, controle dos equipamentos e desmontagem."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou e solucionou com segurança as falhas de áudio ocorridas durante a montagem ou operação, utilizando os procedimentos e recursos disponíveis?",
        "considerar": "diagnóstico, agilidade, segurança e comunicação durante a solução."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Assumiu a responsabilidade técnica pela sua frente, mantendo comunicação clara com a produção e postura profissional e discreta diante do cliente?",
    ...
    "Técnico de Som II": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Planejou e coordenou a preparação da sua frente de áudio, antecipando necessidades de equipamentos, cabeamento, conexões e configuração para garantir a liberação dentro do cronograma?",
        "considerar": "planejamento, antecipação de riscos, organização e cumprimento dos prazos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Validou a configuração do sistema de áudio, garantindo qualidade e estabilidade do sinal, níveis adequados e funcionamento dos equipamentos durante toda a operação?",
        "considerar": "qualidade sonora, estabilidade, testes, regulagem e identificação preventiva de falhas."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle técnico e operacional sobre os equipamentos, cabos e recursos da sua frente, garantindo organização durante a operação e eficiência no desmonte?",
      ...
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Diante de uma intercorrência de áudio, realizou o diagnóstico e conduziu a solução com agilidade, utilizando equipamentos ou caminhos alternativos quando necessário?",
        "considerar": "diagnóstico, tomada de decisão, recursos de backup e controle durante situações de pressão."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Atuou como referência técnica da sua frente, mantendo comunicação objetiva com produção, equipe e cliente e conduzindo as demandas com segurança e profissionalismo?",
        "considerar": "liderança técnica, comunicação, postura e segurança nas decisões."
      }
    },
    "Técnico de Som III": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Conduziu o planejamento técnico do sistema de áudio, antecipando necessidades e riscos e garantindo que toda a estrutura estivesse preparada para a entrega dentro do cronograma global?",
        "considerar": "visão antecipada, planejamento, gestão de riscos e cumprimento do cronograma."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Garantiu a qualidade técnica final do sistema de áudio, validando sinal, níveis, processamento, cobertura e desempenho sonoro de acordo com as necessidades do evento?",
        "considerar": "excelência técnica, qualidade sonora, validação final e estabilidade durante a operação."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Garantiu o controle e a preservação dos equipamentos da frente de áudio, mantendo organização durante a operação e assegurando um desmonte eficiente e sem avarias?",
        "considerar": "gestão do patrimônio, organização, conferência, agilidade e segurança no desmonte."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Conduziu a solução de intercorrências críticas de áudio com rapidez e segurança, tomando decisões técnicas que preservaram a continuidade e a qualidade do evento?",
        "considerar": "diagnóstico avançado, uso de redundâncias, tomada de decisão sob pressão e proteção da entrega."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Atuou como principal referência técnica da frente, conduzindo a equipe e mantendo comunicação segura, profissional e discreta com produção e cliente durante todo o evento?",
  ...
  "ILUMINACAO": {
    "Auxiliar de Iluminação I": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Cumpriu o horário e realizou o descarregamento, movimentação dos cases e separação dos refletores, cabos, pedestais e acessórios necessários para o início da montagem?",
        "considerar": "pontualidade, agilidade, preparação dos materiais e cumprimento do cronograma."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou a montagem e conexão dos equipamentos de iluminação conforme orientação, mantendo refletores, estruturas, cabos e acessórios corretamente instalados?",
        "considerar": "montagem correta, conexões, posicionamento dos equipamentos e ausência de erros que gerem retrabalho."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manuseou refletores, cabos, cases e demais equipamentos com cuidado e manteve a área de trabalho organizada durante a montagem e desmontagem?",
        "considerar": "zelo pelo patrimônio, prevenção de danos, organização da frente e acondicionamento dos equipamentos."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Ao identificar um refletor, cabo ou conexão com problema, comunicou rapidamente o responsável técnico e seguiu o procedimento indicado para a correção?",
        "considerar": "atenção às falhas, comunicação rápida e respeito aos limites da função."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
    ...
    "Auxiliar de Iluminação II": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Antecipou a separação e preparação dos refletores, cabos, acessórios e demais equipamentos necessários para sua frente, garantindo que a montagem avançasse dentro do cronograma?",
        "considerar": "preparação antecipada, organização, iniciativa e capacidade de evitar esperas ou atrasos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou a montagem, posicionamento e conexão dos equipamentos de iluminação com precisão, reduzindo erros e necessidade de retrabalho?",
        "considerar": "qualidade da montagem, conexões, posicionamento dos equipamentos e domínio das atividades esperadas para o nível."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve os equipamentos, cabos, cases e acessórios organizados durante a operação e contribuiu para a conferência e acondicionamento dos materiais?",
        "considerar": "zelo pelo patrimônio, organização da frente, conferência e prevenção de perdas ou danos."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou e corrigiu problemas simples de montagem, cabeamento ou conexão dos equipamentos de iluminação dentro de sua capacidade, acionando o responsável quando necessário?",
        "considerar": "identificação de falhas, iniciativa para correção e capacidade de reconhecer situações que precisam de apoio técnico."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
    ...
    "Auxiliar de Iluminação III": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Antecipou as necessidades de equipamentos, cabos e acessórios da sua frente, garantindo que a equipe tivesse os recursos necessários para cumpir o cronograma de montagem?",
        "considerar": "planejamento, antecipação de necessidades, organização e capacidade de evitar paradas por falta de material."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou a montagem, posicionamento e conexão dos equipamentos de iluminação com autonomia, precisão e dentro do padrão esperado para a entrega?",
        "considerar": "domínio da montagem, qualidade das conexões, posicionamento correto dos equipamentos, autonomia e baixa necessidade de acompanhamento."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle sobre os equipamentos e materiais da sua frente, garantindo organização, conferência e acondicionamento correto durante todo o evento?",
      ...
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou rapidamente problemas de montagem, cabeamento ou equipamentos de iluminação e contribuiu para a solução dentro de sua capacidade?",
        "considerar": "percepção de falhas, agilidade, iniciativa e capacidade de direcionar corretamente situações que ultrapassem sua responsabilidade."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
    ...
    "Assistente de Iluminação I": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Entregou a preparação dos refletores, cabos, conexões e acessórios da sua frente dentro do prazo definido para a montagem e o ensaio técnico?",
        "considerar": "pontualidade, preparação, organização dos materiais e cumprimento do cronograma."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou as conexões, montagem e posicionamento dos equipamentos de iluminação conforme o padrão técnico orientado, garantindo que sua frente estivesse pronta para a operação?",
        "considerar": "conexões corretas, posicionamento, organização dos cabos e ausência de falhas causadas pela montagem."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve refletores, cabos, cases, acessórios e demais equipamentos organizados e protegidos durante a montagem, operação e desmontagem?",
        "considerar": "zelo pelo patrimônio, organização da House, acondicionamento e cuidado com os equipamentos."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Ao identificar falhas simples em refletores, cabos ou conexões, conseguiu realizar a correção adequada ou acionou rapidamente o responsável técnico?",
        "considerar": "percepção da falha, agilidade, procedimento correto e comunicação."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
    ...
    "Assistente de Iluminação II": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Antecipou a preparação dos equipamentos, cabos e conexões da sua frente, garantindo que a iluminação estivesse pronta para os testes e ensaio dentro do cronograma?",
        "considerar": "antecipação, organização, iniciativa e capacidade de evitar atrasos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou e validou as conexões e o funcionamento dos equipamentos de iluminação, garantindo que sua frente estivesse corretamente configurada para a operação?",
        "considerar": "qualidade das conexões, testes, posicionamento dos equipamentos e identificação preventiva de falhas."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle e organização dos equipamentos, cabos e acessórios da sua frente durante toda a operação, evitando perdas, danos ou desorganização?",
      ...
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Diante de uma falha de equipamento, cabeamento ou conexão, conseguiu identificar e corrigir problemas de baixa e média complexidade sem comprometer a operação?",
        "considerar": "diagnóstico, iniciativa, segurança na correção e capacidade de acionar o técnico quando necessário."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
    ...
    "Assistente de Iluminação III": {
      ...
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou e validou a montagem e configuração dos equipamentos de iluminação com autonomia, garantindo posicionamento, conexões e funcionamento adequado para a operação?",
        "considerar": "domínio técnico, qualidade dos testes, identificação preventiva de falhas e baixa necessidade de acompanhamento."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
      ...
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou e solucionou com agilidade falhas de equipamentos, cabeamento ou conexões dentro de sua capacidade, direcionando corretamente os problemas que exigiam atuação técnica?",
        "considerar": "diagnóstico, autonomia, agilidade, segurança e capacidade de reconhecer limites técnicos."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
    ...
    "Técnico de Iluminação I": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Preparou e validou o sistema de iluminação da sua frente, incluindo equipamentos, cabeamento, endereçamento e testes, garantindo a liberação dentro do cronograma do evento?",
        "considerar": "planejamento, organização, testes e cumprimento do horário de liberação."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Garantiu o funcionamento adequado dos equipamentos de iluminação, com posicionamento, endereçamento, comunicação e operação conforme o projeto técnico do evento?",
        "considerar": "configuração, funcionamento dos equipamentos, qualidade dos testes e ausência de falhas decorrentes da montagem."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve a House e os equipamentos de iluminação organizados, garantindo o correto uso, identificação, proteção e acondicionamento dos materiais durante o evento?",
        "considerar": "organização técnica, zelo pelo patrimônio, controle dos equipamentos e desmontagem."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou e solucionou com segurança falhas de equipamentos, cabeamento, endereçamento ou comunicação ocorridas durante a montagem ou operação?",
        "considerar": "diagnóstico, agilidade, segurança e comunicação durante a solução."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
    ...
    "Técnico de Iluminação II": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Planejou e coordenou a preparação da sua frente de iluminação, antecipando necessidades de equipamentos, endereçamento, cabeamento e configuração para garantir a liberação dentro do cronograma?",
        "considerar": "planejamento, antecipação de riscos, organização e cumprimento dos prazos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Validou a configuração do sistema de iluminação, garantindo o funcionamento dos equipamentos, comunicação adequada e execução do projeto conforme as necessidades técnicas do evento?",
        "considerar": "configuração, testes, comunicação entre equipamentos, operação e identificação preventiva de falhas."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle técnico e operacional sobre os equipamentos, cabos e recursos da sua frente, garantindo organização durante a operação e eficiência no desmonte?",
      ...
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Diante de uma intercorrência de iluminação, realizou o diagnóstico e conduziu a solução com agilidade, utilizando recursos ou equipamentos alternativos quando necessário?",
        "considerar": "diagnóstico, tomada de decisão, recursos de backup e controle durante situações de pressão."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
    ...
    "Técnico de Iluminação III": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Conduziu o planejamento técnico do sistema de iluminação, antecipando necessidades e riscos e garantindo que equipamentos, endereçamento, comunicação e configuração estivessem preparados para a entrega dentro do cronograma global?",
        "considerar": "visão antecipada, planejamento, gestão de riscos e cumprimento do cronograma."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Garantiu a qualidade técnica final do sistema de iluminação, validando configuração, comunicação, funcionamento dos equipamentos e execução do projeto durante toda a operação?",
        "considerar": "excelência técnica, validação final, estabilidade e qualidade da entrega."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Garantiu o controle e a preservação dos equipamentos da frente de iluminação, mantendo organização durante a operação e assegurando um desmonte eficiente, seguro e sem avarias?",
        "considerar": "gestão do patrimônio, organização, conferência, agilidade e segurança no desmonte."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Conduziu a solução de intercorrências críticas de iluminação com rapidez e segurança, tomando decisões técnicas que preservaram a continuidade e a qualidade do evento?",
        "considerar": "diagnóstico avançado, uso de alternativas, tomada de decisão sob pressão e proteção da entrega."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Atuou como principal referência técnica da frente, conduzindo a equipe e mantendo comunicação segura, profissional e discreta com produção e cliente durante todo o evento?",
  ...
  "HOUSE_TECNOLOGIA": {
    "Auxiliar de House/Tecnologia I": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Cumpriu o horário e realizou a separação, movimentação e preparação dos equipamentos, cabos, adaptadores e acessórios necessários para a montagem da House?",
        "considerar": "pontualidade, agilidade, organização dos materiais e cumprimento do cronograma."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou a montagem, conexão e organização dos equipamentos de tecnologia conforme orientação, mantendo cabos, conexões e equipamentos corretamente instalados?",
        "considerar": "montagem correta, conexões, identificação dos equipamentos e ausência de erros que gerem retrabalho."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manuseou notebooks, cabos, adaptadores, periféricos e demais equipamentos com cuidado e manteve a House organizada durante a montagem e desmontagem?",
        "considerar": "zelo pelo patrimônio, organização da bancada, acondicionamento e prevenção de danos."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Ao identificar uma falha em cabo, conexão, adaptador ou equipamento, comunicou rapidamente o responsável técnico e seguiu o procedimento indicado para a correção?",
        "considerar": "atenção às falhas, comunicação rápida e respeito aos limites da função."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Manteve postura profissional e discreta durante o evento, respeitando o cliente, a produção e a equipe e evitando interferências indevidas nos equipamentos?",
        "considerar": "apresentação pessoal, educação, discrição, uso adequado do celular, circulação nas áreas do cliente e cumprimento das orientações."
      }
    },
    "Auxiliar de House/Tecnologia II": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Antecipou a separação e preparação dos equipamentos, cabos, adaptadores e acessórios necessários para sua frente, garantindo que a montagem avançasse dentro do cronograma?",
        "considerar": "preparação antecipada, organização, iniciativa e capacidade de evitar esperas ou atrasos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou a montagem, conexão e organização dos equipamentos de tecnologia com precisão, reduzindo erros e necessidade de retrabalho?",
        "considerar": "qualidade das conexões, organização dos cabos, identificação dos equipamentos e domínio das atividades esperadas para o nível."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve os equipamentos, cabos, cases e acessórios organizados durante a operação e contribuiu para a conferência e acondicionamento dos materiais?",
        "considerar": "zelo pelo patrimônio, organização da House, conferência e prevenção de perdas ou danos."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou e corrigiu problemas simples de conexão, cabeamento ou configuração dos equipamentos dentro de sua capacidade, acionando o responsável quando necessário?",
        "considerar": "identificação de falhas, iniciativa para correção e capacidade de reconhecer situações que precisam de apoio técnico."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Manteve postura profissional e discreta, comunicando-se adequadamente com a produção e respeitando o cliente durante a operação?",
        "considerar": "educação, discrição, comunicação, uso adequado do celular, cuidado ao circular nas áreas do cliente e prontidão para atender às orientações."
      }
    },
    "Auxiliar de House/Tecnologia III": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Antecipou as necessidades de equipamentos, cabos, adaptadores e acessórios da sua frente, garantindo que a House tivesse os recursos necessários para cumprir o cronograma?",
        "considerar": "planejamento, antecipação de necessidades, organização e capacidade de evitar paradas por falta de material."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou a montagem, conexão e organização dos equipamentos de tecnologia com autonomia, precisão e dentro do padrão esperado para a entrega?",
        "considerar": "domínio da montagem, qualidade das conexões, organização e baixa necessidade de acompanhamento."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle sobre os equipamentos e materiais da sua frente, garantindo organização, conferência e acondicionamento correto durante todo o evento?",
      ...
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou rapidamente problemas de conexão, cabeamento ou equipamentos de tecnologia e contribuiu para a solução dentro de sua capacidade?",
        "considerar": "percepção de falhas, agilidade, iniciativa e capacidade de direcionar corretamente situações que ultrapassem sua responsabilidade."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
    ...
    "Assistente de House/Tecnologia I": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Entregou a preparação dos equipamentos, cabos, conexões, adaptadores e periféricos da sua frente dentro do prazo definido para a montagem e os testes?",
        "considerar": "pontualidade, preparação, organização dos materiais e cumprimento do cronograma."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou as conexões, montagem e organização dos equipamentos de tecnologia conforme o padrão técnico orientado, garantindo que sua frente estivesse pronta para a operação?",
        "considerar": "conexões corretas, organização dos cabos, identificação dos equipamentos e ausência de falhas causadas pela montagem."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve equipamentos, cabos, cases e acessórios organizados e protegidos durante a montagem, operação e desmontagem?",
        "considerar": "zelo pelo patrimônio, organização da House, conferência e acondicionamento."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Ao identificar falhas simples em equipamentos, cabos ou conexões, conseguiu realizar a correção adequada ou acionou rapidamente o responsável técnico?",
        "considerar": "percepção da falha, agilidade, procedimento correto e comunicação."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Manteve postura profissional e discreta durante o evento, atendendo às orientações da produção e respeitando o cliente?",
        "considerar": "educação, discrição, comunicação, uso adequado do celular e comportamento no ambiente do cliente."
      }
    },
    "Assistente de House/Tecnologia II": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Antecipou a preparação dos equipamentos, cabos, conexões e recursos tecnológicos da sua frente, garantindo que a House estivesse pronta para os testes dentro do cronograma?",
        "considerar": "antecipação, organização, iniciativa e capacidade de evitar atrasos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou e validou as conexões e o funcionamento dos equipamentos de tecnologia, garantindo que sua frente estivesse corretamente configurada para a operação?",
        "considerar": "qualidade das conexões, testes, organização e identificação preventiva de falhas."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle e organização dos equipamentos, cabos, adaptadores e acessórios da sua frente durante toda a operação, evitando perdas, danos ou desorganização?",
        "considerar": "zelo pelo patrimônio, organização da House, conferência e acondicionamento."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
    ...
    "Assistente de House/Tecnologia III": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Planejou e antecipou as necessidades de equipamentos, conexões e recursos tecnológicos da sua frente, garantindo a preparação do sistema dentro do cronograma do evento?",
        "considerar": "planejamento, antecipação, autonomia e capacidade de evitar paradas ou atrasos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou e validou a montagem, conexão e configuração dos equipamentos de tecnologia com autonomia, garantindo funcionamento adequado para a operação?",
        "considerar": "domínio técnico, qualidade dos testes, identificação preventiva de falhas e baixa necessidade de acompanhamento."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
    ...
    "Técnico de House/Tecnologia I": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Preparou e validou o sistema de tecnologia da sua frente, incluindo equipamentos, cabeamento, conexões, sinal e testes, garantindo a liberação dentro do cronograma do evento?",
        "considerar": "planejamento, organização, testes e cumprimento do horário de liberação."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Garantiu o funcionamento adequado dos equipamentos e sistemas de tecnologia, com conexões, roteamento de sinal, configuração e operação conforme o projeto técnico do evento?",
        "considerar": "configuração, funcionamento dos equipamentos, qualidade dos testes e ausência de falhas decorrentes da montagem."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve a House e os equipamentos de tecnologia organizados, garantindo o correto uso, identificação, proteção e acondicionamento dos materiais durante o evento?",
        "considerar": "organização técnica, zelo pelo patrimônio, controle dos equipamentos e desmontagem."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou e solucionou com segurança falhas de equipamentos, cabeamento, conexões ou sinal ocorridas durante a montagem ou operação?",
        "considerar": "diagnóstico, agilidade, segurança e comunicação durante a solução."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
    ...
    "Técnico de House/Tecnologia II": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Planejou e coordenou a preparação da sua frente de tecnologia, antecipando necessidades de equipamentos, cabeamento, sinal e configuração para garantir a liberação dentro do cronograma?",
        "considerar": "planejamento, antecipação de riscos, organização e cumprimento dos prazos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Validou a configuração e integração dos equipamentos e sistemas de tecnologia, garantindo estabilidade de sinal, funcionamento adequado e execução do projeto conforme as necessidades do evento?",
        "considerar": "configuração, testes, integração, estabilidade do sistema e identificação preventiva de falhas."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle técnico e operacional sobre os equipamentos, cabos e recursos da sua frente, garantindo organização durante a operação e eficiência no desmonte?",
      ...
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Diante de uma intercorrência de tecnologia, realizou o diagnóstico e conduziu a solução com agilidade, utilizando recursos ou equipamentos alternativos quando necessário?",
        "considerar": "diagnóstico, tomada de decisão, recursos de backup e controle durante situações de pressão."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
    ...
    "Técnico de House/Tecnologia III": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Conduziu o planejamento técnico do sistema de tecnologia, antecipando necessidades e riscos e garantindo que equipamentos, conexões, sinal e configurações estivessem preparados para a entrega dentro do cronograma?",
        "considerar": "visão antecipada, planejamento, gestão de riscos e cumprimento do cronograma."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Garantiu a qualidade técnica final do sistema de tecnologia, validando integração, estabilidade de sinal, funcionamento dos equipamentos e execução do projeto durante toda a operação?",
        "considerar": "excelência técnica, validação final, estabilidade e qualidade da entrega."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Garantiu o controle e a preservação dos equipamentos da frente de tecnologia, mantendo organização durante a operação e assegurando um desmonte eficiente e sem avarias?",
        "considerar": "gestão do patrimônio, organização, conferência, agilidade e segurança no desmonte."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Conduziu a solução de intercorrências críticas de tecnologia com rapidez e segurança, tomando decisões técnicas que preservaram a continuidade e a qualidade do evento?",
        "considerar": "diagnóstico avançado, uso de alternativas, tomada de decisão sob pressão e proteção da entrega."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
  ...
  "ESTRUTURA": {
    "Auxiliar de Estrutura I": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Cumpriu o horário e realizou o descarregamento, movimentação e separação de estruturas, ferramentas, acessórios e materiais necessários para o início da montagem?",
        "considerar": "pontualidade, agilidade, preparação dos materiais e cumprimento do cronograma."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou a montagem e desmontagem das estruturas conforme orientação, utilizando corretamente ferramentas, acessórios e componentes estruturais?",
        "considerar": "execução correta, atenção às orientações, encaixes, fixações e ausência de erros que gerem retrabalho ou risco."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manuseou estruturas, ferramentas, cases e acessórios com cuidado e manteve a área de trabalho organizada durante a montagem e desmontagem?",
        "considerar": "zelo pelo patrimônio, organização da frente, acondicionamento e prevenção de danos."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Ao identificar uma dificuldade na montagem, peça danificada ou situação que pudesse comprometer a estrutura, comunicou rapidamente o responsável e seguiu a orientação para correção?",
        "considerar": "atenção aos riscos, comunicação rápida e respeito aos limites da função."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Manteve postura profissional e discreta durante o evento, respeitando o cliente, a produção e a equipe?",
        "considerar": "educação, apresentação pessoal, uso adequado do celular, cuidado ao circular nas áreas do cliente e cumprimento das orientações."
      }
    },
    "Auxiliar de Estrutura II": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Antecipou a separação e preparação das estruturas, ferramentas, acessórios e materiais necessários para sua frente, garantindo que a montagem avançasse dentro do cronograma?",
        "considerar": "preparação antecipada, organização, iniciativa e capacidade de evitar esperas ou atrasos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou a montagem e desmontagem das estruturas com precisão, seguindo corretamente os procedimentos e reduzindo erros e necessidade de retrabalho?",
        "considerar": "qualidade da montagem, utilização correta dos componentes, atenção às orientações e segurança na execução."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve as estruturas, ferramentas, cases e acessórios organizados durante a operação e contribuiu para a conferência e acondicionamento dos materiais?",
        "considerar": "zelo pelo patrimônio, organização da frente, conferência e prevenção de perdas ou danos."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou e corrigiu dificuldades simples de montagem ou utilização dos componentes dentro de sua capacidade, acionando o responsável quando necessário?",
        "considerar": "identificação de problemas, iniciativa, segurança e capacidade de reconhecer situações que precisam de apoio."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Manteve postura profissional e discreta, comunicando-se adequadamente com a produção e respeitando o cliente durante a montagem e o evento?",
        "considerar": "educação, discrição, comunicação, uso adequado do celular e comportamento no ambiente do cliente."
      }
    },
    "Auxiliar de Estrutura III": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Antecipou as necessidades de estruturas, ferramentas, acessórios e materiais da sua frente, garantindo que a equipe tivesse os recursos necessários para cumprir o cronograma?",
        "considerar": "planejamento, antecipação de necessidades, organização e capacidade de evitar paradas por falta de material."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou a montagem e desmontagem das estruturas com autonomia, precisão e atenção aos procedimentos de segurança e ao padrão esperado para a entrega?",
        "considerar": "domínio da montagem, segurança, qualidade da execução, autonomia e baixa necessidade de acompanhamento."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle sobre as estruturas, ferramentas e materiais da sua frente, garantindo organização, conferência e acondicionamento correto durante toda a operação?",
        "considerar": "zelo pelo patrimônio, controle dos materiais, organização dos cases e prevenção de perdas ou danos."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou rapidamente dificuldades ou riscos na montagem e contribuiu para a solução dentro de sua capacidade, direcionando corretamente situações que exigiam atuação do responsável técnico?",
        "considerar": "percepção de riscos, agilidade, iniciativa e segurança para reconhecer limites técnicos."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Demonstrou postura profissional e serviu como referência para os demais auxiliares no relacionamento com a produção, cliente e equipe durante a montagem e o evento?",
        "considerar": "exemplo de comportamento, comunicação, discrição, apresentação pessoal e respeito ao ambiente do cliente."
      }
    },
    "Técnico de Estrutura I": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Preparou e validou a montagem da sua frente de estrutura, garantindo que materiais, ferramentas, componentes e recursos necessários estivessem disponíveis e prontos dentro do cronograma?",
        "considerar": "planejamento, organização, conferência e cumprimento do horário de liberação."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou e validou a montagem das estruturas conforme o projeto e as orientações técnicas, garantindo estabilidade, correta utilização dos componentes e segurança na entrega?",
        "considerar": "qualidade da montagem, fixações, alinhamento, estabilidade, procedimentos de segurança e ausência de falhas."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle das estruturas, ferramentas e acessórios da sua frente, garantindo organização, conservação, conferência e acondicionamento correto dos materiais?",
        "considerar": "controle do patrimônio, organização da frente, conferência e eficiência no desmonte."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou e solucionou com segurança problemas de montagem, encaixe, fixação ou estabilidade ocorridos durante a montagem ou operação?",
        "considerar": "diagnóstico, segurança, agilidade e comunicação durante a solução."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Assumiu a responsabilidade técnica pela sua frente, mantendo comunicação clara com a produção e postura profissional e discreta diante do cliente?",
        "considerar": "responsabilidade, comunicação, liderança técnica, segurança e representação da Firma."
      }
    },
    "Técnico de Estrutura II": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Planejou e coordenou a preparação da sua frente de estrutura, antecipando necessidades, riscos, ferramentas e componentes para garantir a montagem dentro do cronograma?",
        "considerar": "planejamento, antecipação de riscos, organização e cumprimento dos prazos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Validou a execução da estrutura, garantindo estabilidade, alinhamento, fixações e utilização correta dos componentes conforme o projeto e as necessidades do evento?",
        "considerar": "domínio técnico, validação da montagem, segurança e identificação preventiva de falhas."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve controle técnico e operacional sobre as estruturas, ferramentas e materiais da sua frente, garantindo organização durante a montagem e eficiência no desmonte?",
        "considerar": "controle do patrimônio, organização, conferência, acondicionamento e prevenção de avarias."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Diante de uma intercorrência estrutural, realizou o diagnóstico e conduziu a solução com agilidade e segurança, utilizando alternativas adequadas quando necessário?",
        "considerar": "diagnóstico, tomada de decisão, segurança e controle durante situações de pressão."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Atuou como referência técnica da sua frente, mantendo comunicação objetiva com produção, equipe e cliente e conduzindo as demandas com segurança e profissionalismo?",
    ...
    "Técnico de Estrutura III": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Conduziu o planejamento técnico da estrutura, antecipando necessidades e riscos e garantindo que materiais, componentes, ferramentas e recursos estivessem preparados para a entrega dentro do cronograma global?",
        "considerar": "visão antecipada, planejamento, gestão de riscos e cumprimento do cronograma."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Garantiu a qualidade técnica final da estrutura, validando montagem, estabilidade, alinhamento, fixações e segurança durante toda a operação?",
        "considerar": "excelência técnica, validação final, estabilidade e qualidade da entrega."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Garantiu o controle e a preservação dos equipamentos e ferramentas, mantendo organização durante a operação e assegurando um desmonte eficiente, seguro e sem avarias?",
        "considerar": "gestão do patrimônio, organização, conferência, agilidade e segurança no desmonte."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Conduziu a solução de intercorrências críticas de estrutura com rapidez e segurança, tomando decisões técnicas que preservaram a estabilidade, segurança e continuidade do evento?",
        "considerar": "diagnóstico avançado, tomada de decisão sob pressão, uso de alternativas e proteção da entrega."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Atuou como principal referência técnica da frente, conduzindo a equipe e mantendo comunicação segura, profissional e discreta com produção e cliente durante todo o evento?",
  ...
  "ELETRICA": {
    "Técnico II - Elétrica": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Planejou e preparou a infraestrutura elétrica da sua frente, garantindo cabos, quadros, distribuição, conexões, ferramentas e demais recursos necessários para a execução dentro do cronograma?",
        "considerar": "planejamento, organização, conferência dos materiais, antecipação de necessidades e cumprimento do cronograma."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Executou e validou a instalação e distribuição elétrica do evento conforme o projeto e os procedimentos técnicos e de segurança, garantindo o correto funcionamento dos equipamentos alimentados?",
        "considerar": "montagem, distribuição de carga, conexões, organização dos cabos, segurança e ausência de falhas decorrentes da execução."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Manteve quadros, cabos, ferramentas e demais materiais elétricos organizados, identificados e protegidos durante a montagem, operação e desmontagem?",
        "considerar": "zelo pelo patrimônio, organização da frente, conservação dos materiais, conferência e acondicionamento."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Identificou e solucionou com segurança falhas elétricas ocorridas durante a montagem ou operação, avaliando riscos e acionando o responsável adequado quando a situação exigia maior intervenção?",
        "considerar": "diagnóstico, segurança, agilidade, tomada de decisão e reconhecimento dos limites técnicos."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Assumiu a responsabilidade técnica pela sua frente, mantendo comunicação clara com produção e equipe e postura profissional e discreta diante do cliente?",
        "considerar": "responsabilidade, comunicação, segurança, discrição e representação da Firma."
      }
    },
    "Técnico III - Elétrica": {
      "item1": {
        "titulo": "Pontualidade e Preparação",
        "pergunta": "Conduziu o planejamento técnico da infraestrutura elétrica do evento, antecipando demandas, riscos, cargas, distribuição e recursos necessários para garantir a entrega dentro do cronograma global?",
        "considerar": "planejamento, visão antecipada, gestão de riscos, organização e cumprimento dos prazos."
      },
      "item2": {
        "titulo": "Qualidade da Execução",
        "pergunta": "Garantiu a qualidade técnica da infraestrutura elétrica, validando distribuição, cargas, conexões, quadros e funcionamento do sistema durante toda a operação?",
        "considerar": "excelência técnica, segurança, estabilidade do sistema, validação final e conformidade da execução."
      },
      "item3": {
        "titulo": "Cuidado, Organização e Logística",
        "pergunta": "Garantiu o controle e a preservação dos equipamentos e materiais elétricos, mantendo a infraestrutura organizada, segura e adequadamente acondicionada durante a operação e desmontagem?",
        "considerar": "gestão do patrimônio, organização, identificação, conferência, conservação e segurança."
      },
      "item4": {
        "titulo": "Troubleshooting e Solução de Problemas",
        "pergunta": "Conduziu a solução de intercorrências elétricas críticas com rapidez e segurança, tomando decisões técnicas que preservaram a integridade dos equipamentos, da equipe e a continuidade do evento?",
        "considerar": "diagnóstico avançado, gestão de riscos, tomada de decisão sob pressão, uso de alternativas e segurança."
      },
      "item5": {
        "titulo": "Responsabilidade, Comunicação e Postura no Evento",
        "pergunta": "Atuou como principal referência técnica da elétrica, conduzindo a equipe e mantendo comunicação segura, profissional e discreta com produção e cliente durante todo o evento?",
        "considerar": "liderança técnica, responsabilidade pela entrega, comunicação, postura diante do cliente e capacidade de conduzir a equipe."
      }
    }
  }
}
...
NIVEIS_IMPACTO_CLIENTE = {
    "verde": {
        "label": "🟢 1. NÍVEL EXCELÊNCIA — Acima do Esperado",
        "descricao": (
            "Atuação que superou as expectativas da função, demonstrando iniciativa, "
            "domínio técnico, autonomia e cuidado com a experiência do cliente, "
            "contribuindo para uma entrega diferenciada."
        ),
        "gera_alerta": False,
    },
    "amarelo": {
        "label": "🟡 2. NÍVEL CONFORMIDADE — Dentro do Esperado",
        "descricao": (
            "Entrega realizada de acordo com o escopo e os padrões da Firma, "
            "cumprindo as responsabilidades da função com qualidade, organização, "
            "postura adequada e sem intercorrências relevantes."
        ),
        "gera_alerta": False,
    },
    "laranja": {
        "label": "🟠 3. NÍVEL INCONFORMIDADE — Abaixo do Esperado",
        "descricao": (
            "Foram identificados desvios na execução, comportamento ou cumprimento "
            "das responsabilidades. A situação exigiu orientação ou intervenção "
            "da liderança para correção durante ou após o evento."
        ),
        "gera_alerta": False,
    },
    "vermelho": {
        "label": "🔴 4. NÍVEL CRÍTICO — Muito Abaixo do Esperado",
        "descricao": (
            "Foi identificada falha relevante na execução, comportamento ou cumprimento "
            "das responsabilidades, com impacto significativo na operação, na entrega "
            "ao cliente ou na imagem da Firma, exigindo atuação imediata da liderança."
        ),
        "gera_alerta": True,
    },
}
...
# ---------------------------------------------------------------------------
# Avaliação Comportamental própria da Firma (substitui o indicador externo
# do Gallup). Inventário ipsativo de 30 situações; cada resposta pontua até
# dois talentos (Principal peso 4, Secundário peso 2) numa escala de 0 a 4.
#
# Nota de manutenção: os 7 talentos abaixo (Ativador, Autoconfiança, Carisma,
# Adaptabilidade, Individualização, Maximização, Prudência) apareciam nas
# perguntas mas não tinham domínio definido na primeira versão dos dados —
# foram classificados aqui seguindo a mesma lógica de agrupamento por
# domínio usada no restante do inventário, para nenhuma resposta do
# colaborador ser descartada silenciosamente do cálculo.
# ---------------------------------------------------------------------------
MAPEAMENTO_DOMINIOS = {
    "Execução": ["Realizador", "Iniciador", "Organizador", "Foco", "Responsabilidade", "Solucionador", "Disciplina", "Prudência"],
    "Influência": ["Comunicador", "Mobilizador", "Persuasivo", "Decisivo", "Energizador", "Presença", "Negociador", "Ativador", "Autoconfiança", "Carisma"],
    "Relacionamento": ["Colaborador", "Empático", "Desenvolvedor", "Conector", "Agregador", "Harmonizador", "Apoiador", "Adaptabilidade", "Individualização", "Maximização"],
    "Pensamento Estratégico": ["Analítico", "Estrategista", "Criador", "Aprendiz", "Investigador", "Visionário", "Contextualizador"],
}

# Definição oficial e curta de cada um dos 35 talentos cadastrados no sistema
# — usada tanto para ancorar a interpretação da IA (ela não pode inventar
# significado fora disso) quanto para os cards de talento na tela e para o
# fallback offline. Nomes e domínios não podem ser alterados aqui sem
# atualizar também MAPEAMENTO_DOMINIOS e MATRIZ_TESTE_COMPORTAMENTAL.
DEFINICOES_TALENTOS = {
    "Realizador": "Tem satisfação em produzir e concluir. Sente necessidade constante de realização e mede o dia pelo volume do que foi entregue.",
    "Iniciador": "Prefere começar a agir a ficar planejando demais. Transforma ideias em movimento rapidamente, mesmo com informação incompleta.",
    "Organizador": "Gosta de estruturar recursos, pessoas e etapas para que o trabalho flua sem desperdício. Tem prazer em arrumar o caos em ordem prática.",
    "Foco": "Define uma direção clara e filtra distrações para chegar até ela. Prioriza bem e evita se dispersar em frentes paralelas.",
    "Responsabilidade": "Assume compromissos como se fossem pessoais. Sente-se dono do resultado até a conclusão, mesmo quando ninguém está cobrando.",
    "Solucionador": "Tem prazer em identificar a causa de um problema e resolvê-lo na prática. Prefere agir diretamente a ficar só diagnosticando.",
    "Disciplina": "Cria rotinas, padrões e estrutura para si mesmo. Sente-se mais seguro quando existe um processo claro a seguir.",
    "Prudência": "Avalia riscos com cuidado antes de agir. Prefere ponderar consequências a tomar decisões por impulso.",
    "Comunicador": "Tem facilidade para colocar pensamentos em palavras claras. Gosta de explicar, apresentar e tornar ideias compreensíveis para os outros.",
    "Mobilizador": "Consegue engajar pessoas em torno de uma causa ou objetivo comum, gerando adesão e senso de time.",
    "Persuasivo": "Constrói argumentos convincentes e sabe adaptar a mensagem para conquistar a concordância do outro.",
    "Decisivo": "Sente-se confortável em decidir com as informações disponíveis, sem precisar de certeza absoluta para agir.",
    "Energizador": "Contagia o ambiente com disposição e entusiasmo, elevando o ânimo de quem está por perto.",
    "Presença": "Tem naturalidade em ocupar espaço e ser notado em um grupo, sem precisar se impor artificialmente.",
    "Negociador": "Busca pontos de acordo entre interesses diferentes, encontrando soluções que funcionem para as partes envolvidas.",
    "Ativador": "Prefere agir logo e ajustar o percurso pelo caminho a esperar um planejamento perfeito antes de começar.",
    "Autoconfiança": "Confia no próprio julgamento e capacidade de decisão, sustentando posições mesmo diante de questionamentos.",
    "Carisma": "Cria conexão e simpatia com facilidade, tornando interações novas mais leves e gerando proximidade rápida.",
    "Colaborador": "Prefere construir em conjunto a atuar isoladamente, valorizando o resultado do time acima do protagonismo individual.",
    "Empático": "Percebe com sensibilidade o que o outro está sentindo, o que facilita cuidar das pessoas ao redor.",
    "Desenvolvedor": "Enxerga potencial nas pessoas antes de ele se manifestar e sente satisfação genuína em ajudar alguém a crescer.",
    "Conector": "Identifica pontes entre pessoas, ideias ou áreas diferentes, aproximando o que parecia distante.",
    "Agregador": "Reúne pessoas com perfis diferentes em torno de um objetivo comum, valorizando a força do coletivo.",
    "Harmonizador": "Busca reduzir atritos e encontrar consenso, preferindo a estabilidade das relações a confrontos desnecessários.",
    "Apoiador": "Está disponível para ajudar sem esperar retorno imediato, servindo como uma base de suporte confiável para o time.",
    "Adaptabilidade": "Lida bem com mudanças de plano, ajustando-se ao momento presente em vez de se prender a uma rota fixa.",
    "Individualização": "Percebe o que torna cada pessoa única e ajusta a forma de se relacionar de acordo com essa particularidade.",
    "Maximização": "Enxerga o que já funciona bem e busca levá-lo a um padrão de excelência, em vez de só corrigir o que falha.",
    "Analítico": "Busca dados, evidências e padrões antes de tirar conclusões, questionando afirmações sem base concreta.",
    "Estrategista": "Consegue enxergar caminhos alternativos rapidamente diante de um cenário, antecipando desdobramentos possíveis.",
    "Criador": "Gera ideias novas com naturalidade e gosta de explorar possibilidades ainda não testadas.",
    "Aprendiz": "Sente prazer genuíno no processo de aprender algo novo, mais do que no destino final desse conhecimento.",
    "Investigador": "Tem curiosidade natural por reunir informação e contexto antes de agir ou se posicionar.",
    "Visionário": "Imagina cenários futuros com clareza e se energiza ao pensar em possibilidades que ainda não existem.",
    "Contextualizador": "Entende melhor o presente ao olhar para trás — busca compreender a origem e a lógica histórica das coisas.",
}

MATRIZ_TESTE_COMPORTAMENTAL = {
  "tela_01": {
    "contexto": "01. Quando recebo uma atividade nova:",
    "A": {
      "texto": "Gosto de começar logo e ir avançando enquanto descubro o que for necessário.",
      "pesos": {
        "Ativador": 4,
        "Realizador": 2
      }
    ...
    "B": {
      "texto": "Antes de começar, procuro entender exatamente o que precisa ser alcançado.",
      "pesos": {
        "Foco": 4,
        "Estrategista": 2
      }
    ...
    "C": {
      "texto": "Procuro entender como aquela atividade se relaciona com as pessoas e com o restante do trabalho.",
      "pesos": {
        "Contextualizador": 4,
        "Individualização": 2
      }
  ...
  "tela_02": {
    "contexto": "02. Quando encontro um problema:",
    "A": {
      "texto": "Minha primeira reação é procurar uma forma prática de resolver.",
      "pesos": {
        "Solucionador": 4,
        "Realizador": 2
      }
    ...
    "B": {
      "texto": "Quero entender o que causou o problema antes de decidir o que fazer.",
      "pesos": {
        "Analítico": 4,
        "Contextualizador": 2
      }
    ...
    "C": {
      "texto": "Gosto de ouvir quem está envolvido para entender diferentes pontos de vista.",
      "pesos": {
        "Empático": 4,
        "Harmonizador": 2
      }
  ...
  "tela_03": {
    "contexto": "03. Quando preciso tomar uma decisão:",
    "A": {
      "texto": "Se já tenho informações suficientes, prefiro decidir e seguir em frente.",
      "pesos": {
        "Decisivo": 4,
        "Autoconfiança": 2
      }
    ...
    "B": {
      "texto": "Costumo analisar possibilidades, riscos e consequências antes de escolher.",
      "pesos": {
        "Analítico": 4,
        "Estrategista": 2
      }
    ...
    "C": {
      "texto": "Considero importante entender como a decisão afetará as pessoas envolvidas.",
      "pesos": {
        "Empático": 4,
        "Individualização": 2
      }
  ...
  "tela_04": {
    "contexto": "04. Quando um plano muda de repente:",
    "A": {
      "texto": "Consigo mudar rapidamente a direção e continuar buscando o resultado.",
      "pesos": {
        "Adaptabilidade": 4,
        "Ativador": 2
      }
    ...
    "B": {
      "texto": "Preciso entender o que mudou e reorganizar a situação antes de seguir.",
      "pesos": {
        "Analítico": 4,
        "Contextualizador": 2
      }
    ...
    "C": {
      "texto": "Procuro manter as pessoas alinhadas para que a mudança aconteça sem gerar conflitos desnecessários.",
      "pesos": {
        "Harmonizador": 4,
        "Comunicador": 2
      }
  ...
  "tela_05": {
    "contexto": "05. Quando assumo uma responsabilidade:",
    "A": {
      "texto": "Sinto necessidade de acompanhar até que esteja realmente concluída.",
      "pesos": {
        "Responsabilidade": 4,
        "Realizador": 2
      }
    ...
    "B": {
      "texto": "Gosto de estabelecer claramente o que precisa ser entregue e manter o foco nisso.",
      "pesos": {
        "Foco": 4,
        "Disciplina": 2
      }
    ...
    "C": {
      "texto": "Procuro garantir que todos os envolvidos saibam o que precisam fazer.",
      "pesos": {
        "Comunicador": 4,
        "Organizador": 2
      }
  ...
  "tela_06": {
    "contexto": "06. Quando tenho uma ideia:",
    "A": {
      "texto": "Tenho vontade de colocá-la em prática para descobrir até onde ela pode chegar.",
      "pesos": {
        "Ativador": 4,
        "Criador": 2
      }
    ...
    "B": {
      "texto": "Gosto de desenvolver a ideia, pensando em possibilidades e consequências.",
      "pesos": {
        "Criador": 4,
        "Estrategista": 2
      }
    ...
    "C": {
      "texto": "Gosto de trocar a ideia com outras pessoas e perceber como elas podem contribuir.",
      "pesos": {
        "Comunicador": 4,
        "Agregador": 2
      }
  ...
  "tela_07": {
    "contexto": "07. Em situações de pressão:",
    "A": {
      "texto": "Tendo a aumentar meu ritmo e partir para a ação.",
      "pesos": {
        "Realizador": 4,
        "Ativador": 2
      }
    ...
    "B": {
      "texto": "Procuro manter a calma e analisar antes de agir.",
      "pesos": {
        "Prudência": 4,
        "Analítico": 2
      }
    ...
    "C": {
      "texto": "Procuro conversar com as pessoas envolvidas para organizar a situação.",
      "pesos": {
        "Comunicador": 4,
        "Harmonizador": 2
      }
  ...
  "tela_08": {
    "contexto": "08. Quando alguém apresenta uma ideia muito diferente da minha:",
    "A": {
      "texto": "Se perceber potencial, consigo mudar rapidamente minha direção.",
      "pesos": {
        "Adaptabilidade": 4,
        "Criador": 2
      }
    ...
    "B": {
      "texto": "Quero entender os argumentos antes de decidir se faz sentido mudar.",
      "pesos": {
        "Analítico": 4,
        "Prudência": 2
      }
    ...
    "C": {
      "texto": "Gosto de juntar diferentes perspectivas para chegar a uma solução melhor.",
      "pesos": {
        "Agregador": 4,
        "Estrategista": 2
      }
  ...
  "tela_09": {
    "contexto": "09. Quando começo uma atividade importante:",
    "A": {
      "texto": "Minha tendência é colocar a atividade em movimento rapidamente.",
      "pesos": {
        "Ativador": 4,
        "Realizador": 2
      }
    ...
    "B": {
      "texto": "Prefiro organizar prioridades, etapas e recursos antes de começar.",
      "pesos": {
        "Organizador": 4,
        "Disciplina": 2
      }
    ...
    "C": {
      "texto": "Procuro identificar quem precisa participar para que o trabalho aconteça bem.",
      "pesos": {
        "Agregador": 4,
        "Comunicador": 2
      }
  ...
  "tela_10": {
    "contexto": "10. Quando recebo um feedback:",
    "A": {
      "texto": "Procuro transformar rapidamente aquilo em uma mudança prática.",
      "pesos": {
        "Realizador": 4,
        "Desenvolvedor": 2
      }
    ...
    "B": {
      "texto": "Quero entender profundamente o motivo daquele feedback.",
      "pesos": {
        "Analítico": 4,
        "Aprendiz": 2
      }
    ...
    "C": {
      "texto": "Valorizo entender a percepção da outra pessoa e como minha atitude foi recebida.",
      "pesos": {
        "Empático": 4,
        "Individualização": 2
      }
  ...
  "tela_11": {
    "contexto": "11. Quando preciso convencer alguém:",
    "A": {
      "texto": "Gosto de apresentar argumentos claros mostrando por que minha ideia pode funcionar.",
      "pesos": {
        "Comunicador": 4,
        "Decisivo": 2
      }
    ...
    "B": {
      "texto": "Primeiro procuro entender o que é importante para aquela pessoa.",
      "pesos": {
        "Individualização": 4,
        "Empático": 2
      }
    ...
    "C": {
      "texto": "Procuro apresentar a ideia de uma maneira que gere interesse e envolvimento.",
      "pesos": {
        "Carisma": 4,
        "Comunicador": 2
      }
  ...
  "tela_12": {
    "contexto": "12. Quando preciso aprender algo novo:",
    "A": {
      "texto": "Aprendo melhor quando posso experimentar e fazer na prática.",
      "pesos": {
        "Realizador": 4,
        "Ativador": 2
      }
    ...
    "B": {
      "texto": "Gosto de entender profundamente como aquilo funciona.",
      "pesos": {
        "Aprendiz": 4,
        "Analítico": 2
      }
    ...
    "C": {
      "texto": "Gosto de aprender observando pessoas que já dominam aquilo.",
      "pesos": {
        "Desenvolvedor": 4,
        "Investigador": 2
      }
  ...
  "tela_13": {
    "contexto": "13. Quando percebo que alguém está tendo dificuldade:",
    "A": {
      "texto": "Tenho vontade de ajudar diretamente a resolver a situação.",
      "pesos": {
        "Solucionador": 4,
        "Realizador": 2
      }
    ...
    "B": {
      "texto": "Procuro entender a dificuldade e ajudar a pessoa a encontrar seu próprio caminho.",
      "pesos": {
        "Desenvolvedor": 4,
        "Empático": 2
      }
    ...
    "C": {
      "texto": "Consigo perceber capacidades naquela pessoa que talvez ainda não estejam sendo utilizadas.",
      "pesos": {
        "Maximização": 4,
        "Individualização": 2
      }
  ...
  "tela_14": {
    "contexto": "14. Quando tenho muitas tarefas ao mesmo tempo:",
    "A": {
      "texto": "Defino o que precisa ser feito primeiro e começo a executar.",
      "pesos": {
        "Foco": 4,
        "Realizador": 2
      }
    ...
    "B": {
      "texto": "Organizo as tarefas para evitar retrabalho e perda de tempo.",
      "pesos": {
        "Organizador": 4,
        "Disciplina": 2
      }
    ...
    "C": {
      "texto": "Avalio quais pessoas precisam estar envolvidas em cada atividade.",
      "pesos": {
        "Agregador": 4,
        "Individualização": 2
      }
  ...
  "tela_15": {
    "contexto": "15. Quando preciso apresentar uma ideia:",
    "A": {
      "texto": "Gosto de defender aquilo em que acredito com segurança.",
      "pesos": {
        "Autoconfiança": 4,
        "Decisivo": 2
      }
    ...
    "B": {
      "texto": "Procuro estruturar meu raciocínio antes de apresentar.",
      "pesos": {
        "Analítico": 4,
        "Comunicador": 2
      }
    ...
    "C": {
      "texto": "Adapto minha forma de explicar conforme a pessoa que está me ouvindo.",
      "pesos": {
        "Individualização": 4,
        "Comunicador": 2
      }
  ...
  "tela_16": {
    "contexto": "16. Quando algo dá errado:",
    "A": {
      "texto": "Quero resolver o problema primeiro para que o trabalho continue.",
      "pesos": {
        "Solucionador": 4,
        "Realizador": 2
      }
    ...
    "B": {
      "texto": "Procuro entender a causa para evitar que aconteça novamente.",
      "pesos": {
        "Analítico": 4,
        "Contextualizador": 2
      }
    ...
    "C": {
      "texto": "Também considero quem foi impactado pela situação e como lidar com isso.",
      "pesos": {
        "Empático": 4,
        "Harmonizador": 2
      }
  ...
  "tela_17": {
    "contexto": "17. Quando percebo uma oportunidade de melhoria:",
    "A": {
      "texto": "Tenho tendência a tomar a iniciativa em vez de esperar alguém pedir.",
      "pesos": {
        "Ativador": 4,
        "Decisivo": 2
      }
    ...
    "B": {
      "texto": "Quero avaliar se a mudança realmente vai melhorar o resultado.",
      "pesos": {
        "Analítico": 4,
        "Estrategista": 2
      }
    ...
    "C": {
      "texto": "Penso em como envolver as pessoas para que a melhoria seja realmente adotada.",
      "pesos": {
        "Comunicador": 4,
        "Agregador": 2
      }
  ...
  "tela_18": {
    "contexto": "18. Quando trabalho com alguém muito diferente de mim:",
    "A": {
      "texto": "Procuro rapidamente uma maneira prática de trabalhar bem com aquela pessoa.",
      "pesos": {
        "Adaptabilidade": 4,
        "Harmonizador": 2
      }
    ...
    "B": {
      "texto": "Tenho curiosidade para entender como aquela pessoa pensa e trabalha.",
      "pesos": {
        "Individualização": 4,
        "Investigador": 2
      }
    ...
    "C": {
      "texto": "Adapto minha comunicação para facilitar nossa relação.",
      "pesos": {
        "Empático": 4,
        "Comunicador": 2
      }
  ...
  "tela_19": {
    "contexto": "19. Quando recebo muitas informações novas:",
    "A": {
      "texto": "Procuro identificar rapidamente o que realmente preciso para agir.",
      "pesos": {
        "Foco": 4,
        "Investigador": 2
      }
    ...
    "B": {
      "texto": "Tenho vontade de pesquisar mais antes de chegar a uma conclusão.",
      "pesos": {
        "Investigador": 4,
        "Aprendiz": 2
      }
    ...
    "C": {
      "texto": "Gosto de conversar com pessoas que possuem experiências diferentes sobre o assunto.",
      "pesos": {
        "Agregador": 4,
        "Investigador": 2
      }
  ...
  "tela_20": {
    "contexto": "20. Quando penso no futuro:",
    "A": {
      "texto": "Penso no que precisa ser feito hoje para chegar ao resultado desejado.",
      "pesos": {
        "Foco": 4,
        "Estrategista": 2
      }
    ...
    "B": {
      "texto": "Consigo imaginar possibilidades que ainda não existem.",
      "pesos": {
        "Visionário": 4,
        "Criador": 2
      }
    ...
    "C": {
      "texto": "Penso em como as pessoas podem participar da construção desse futuro.",
      "pesos": {
        "Agregador": 4,
        "Desenvolvedor": 2
      }
  ...
  "tela_21": {
    "contexto": "21. Quando existe um risco envolvido:",
    "A": {
      "texto": "Se acredito que o resultado vale a pena, tenho disposição para avançar.",
      "pesos": {
        "Autoconfiança": 4,
        "Decisivo": 2
      }
    ...
    "B": {
      "texto": "Procuro avaliar cuidadosamente o que pode dar errado.",
      "pesos": {
        "Prudência": 4,
        "Analítico": 2
      }
    ...
    "C": {
      "texto": "Gosto de ouvir diferentes perspectivas antes de assumir o risco.",
      "pesos": {
        "Harmonizador": 4,
        "Agregador": 2
      }
  ...
  "tela_22": {
    "contexto": "22. Quando sigo um processo:",
    "A": {
      "texto": "Procuro cumprir o processo, mas também encontrar maneiras de fazê-lo funcionar melhor.",
      "pesos": {
        "Realizador": 4,
        "Solucionador": 2
      }
    ...
    "B": {
      "texto": "Gosto de ter regras, etapas e padrões claros.",
      "pesos": {
        "Disciplina": 4,
        "Organizador": 2
      }
    ...
    "C": {
      "texto": "Tenho interesse em entender por que aquele processo existe e qual impacto ele gera.",
      "pesos": {
        "Contextualizador": 4,
        "Analítico": 2
      }
  ...
  "tela_23": {
    "contexto": "23. Quando percebo potencial em alguém:",
    "A": {
      "texto": "Gosto de incentivar a pessoa a assumir novos desafios.",
      "pesos": {
        "Desenvolvedor": 4,
        "Ativador": 2
      }
    ...
    "B": {
      "texto": "Procuro identificar aquilo que ela faz especialmente bem.",
      "pesos": {
        "Maximização": 4,
        "Individualização": 2
      }
    ...
    "C": {
      "texto": "Gosto de acompanhar a evolução e contribuir para que ela cresça.",
      "pesos": {
        "Desenvolvedor": 4,
        "Responsabilidade": 2
      }
  ...
  "tela_24": {
    "contexto": "24. Quando surge um conflito:",
    "A": {
      "texto": "Prefiro enfrentar a situação e buscar uma solução objetiva.",
      "pesos": {
        "Decisivo": 4,
        "Solucionador": 2
      }
    ...
    "B": {
      "texto": "Procuro compreender os diferentes lados antes de me posicionar.",
      "pesos": {
        "Analítico": 4,
        "Empático": 2
      }
    ...
    "C": {
      "texto": "Procuro preservar a relação mesmo quando existe discordância.",
      "pesos": {
        "Harmonizador": 4,
        "Empático": 2
      }
  ...
  "tela_25": {
    "contexto": "25. Quando uma tarefa fica parada:",
    "A": {
      "texto": "Tenho dificuldade de simplesmente esperar; procuro alguma forma de destravá-la.",
      "pesos": {
        "Ativador": 4,
        "Solucionador": 2
      }
    ...
    "B": {
      "texto": "Quero entender exatamente o que está impedindo o avanço.",
      "pesos": {
        "Analítico": 4,
        "Contextualizador": 2
      }
    ...
    "C": {
      "texto": "Procuro identificar quem pode ajudar a fazer a atividade avançar.",
      "pesos": {
        "Comunicador": 4,
        "Agregador": 2
      }
  ...
  "tela_26": {
    "contexto": "26. Quando tenho liberdade para trabalhar:",
    "A": {
      "texto": "Gosto de ter autonomia para decidir como chegar ao resultado.",
      "pesos": {
        "Autoconfiança": 4,
        "Realizador": 2
      }
    ...
    "B": {
      "texto": "Gosto de estruturar minha própria maneira de organizar o trabalho.",
      "pesos": {
        "Organizador": 4,
        "Disciplina": 2
      }
    ...
    "C": {
      "texto": "Gosto de experimentar novas ideias e possibilidades.",
      "pesos": {
        "Criador": 4,
        "Visionário": 2
      }
  ...
  "tela_27": {
    "contexto": "27. Quando conheço uma pessoa nova:",
    "A": {
      "texto": "Tenho facilidade para iniciar uma conversa e criar proximidade.",
      "pesos": {
        "Carisma": 4,
        "Comunicador": 2
      }
    ...
    "B": {
      "texto": "Costumo observar primeiro para entender como aquela pessoa funciona.",
      "pesos": {
        "Individualização": 4,
        "Contextualizador": 2
      }
    ...
    "C": {
      "texto": "Procuro rapidamente algum ponto em comum para criar conexão.",
      "pesos": {
        "Agregador": 4,
        "Adaptabilidade": 2
      }
  ...
  "tela_28": {
    "contexto": "28. Quando quero melhorar meu próprio desempenho:",
    "A": {
      "texto": "Defino um objetivo e trabalho para alcançá-lo.",
      "pesos": {
        "Foco": 4,
        "Realizador": 2
      }
    ...
    "B": {
      "texto": "Procuro identificar exatamente o que preciso melhorar e acompanhar minha evolução.",
      "pesos": {
        "Analítico": 4,
        "Disciplina": 2
      }
    ...
    "C": {
      "texto": "Busco aprender com pessoas que já desenvolveram aquela competência.",
      "pesos": {
        "Aprendiz": 4,
        "Desenvolvedor": 2
      }
  ...
  "tela_29": {
    "contexto": "29. Quando preciso equilibrar velocidade e qualidade:",
    "A": {
      "texto": "Procuro uma maneira de entregar rapidamente sem comprometer o essencial.",
      "pesos": {
        "Realizador": 4,
        "Solucionador": 2
      }
    ...
    "B": {
      "texto": "Prefiro garantir que o trabalho esteja bem feito antes de considerar concluído.",
      "pesos": {
        "Responsabilidade": 4,
        "Prudência": 2
      }
    ...
    "C": {
      "texto": "Avalio o contexto para entender qual equilíbrio faz mais sentido.",
      "pesos": {
        "Estrategista": 4,
        "Adaptabilidade": 2
      }
  ...
  "tela_30": {
    "contexto": "30. Quando penso na minha forma de trabalhar:",
    "A": {
      "texto": "Gosto de transformar ideias em movimento e resultados concretos.",
      "pesos": {
        "Realizador": 4,
        "Ativador": 2
      }
    ...
    "B": {
      "texto": "Gosto de compreender situações, enxergar possibilidades e encontrar caminhos.",
      "pesos": {
        "Estrategista": 4,
        "Analítico": 2
      }
    ...
    "C": {
      "texto": "Gosto de construir junto, envolver pessoas e fazer as coisas acontecerem por meio das relações.",
      "pesos": {
        "Comunicador": 4,
        "Agregador": 2
      }
...
def obter_itens_campo(area: str, cargo: str) -> dict:
    """Retorna os 5 itens do gabarito de campo (Avaliação de Entrega
    Técnica) para o cargo específico, quando cadastrados em
    ITENS_CAMPO_POR_CARGO. Se a área/cargo ainda não tiver conteúdo
    específico (hoje: Estrutura e Elétrica), cai no gabarito genérico por
    trilha (Auxiliar x Assistente/Técnico) como fallback, para o sistema
    nunca ficar sem perguntas para nenhum cargo."""
    especificos = ITENS_CAMPO_POR_CARGO.get(area, {}).get(cargo)
    if especificos:
        return {
            item_id: {
                "titulo": dados["titulo"],
                "pergunta": dados["pergunta"],
                "considerar": dados.get("considerar", ""),
            }
            for item_id, dados in especificos.items()
        }
    trilha_auxiliar = cargo_e_auxiliar(cargo)
    return {
        item_id: {
            "titulo": item["titulo"],
        ...
        for item_id, item in ITENS_CAMPO_GENERICO_FALLBACK.items()
    }
...
def init_db():
    with get_conn() as conn:
        conn.executescript(
            ...
            CREATE TABLE IF NOT EXISTS perfis_comportamentais (
                colaborador_id TEXT PRIMARY KEY REFERENCES colaboradores(id),
                data_teste TEXT NOT NULL,
                dominio_principal TEXT NOT NULL,
                top_talentos TEXT NOT NULL,
                pontos_desenvolvimento TEXT NOT NULL,
                narrativa_ia TEXT
            );

            CREATE TABLE IF NOT EXISTS pdis_emitidos (
                colaborador_id TEXT NOT NULL REFERENCES colaboradores(id),
                periodo TEXT NOT NULL,
                ...
                media_parte_a REAL,
                media_parte_b REAL,
                compilado TEXT NOT NULL,
                plano TEXT NOT NULL,
                PRIMARY KEY (colaborador_id, periodo)
            );
            """
        )
...
def criar_colaborador(nome, area, cargo, data_admissao, data_inicio_nivel) -> str:
    novo_id = str(uuid.uuid4())[:8]
    with get_conn() as conn:
        conn.execute(
            """INSERT INTO colaboradores
               (id, nome, area, cargo, data_admissao, data_inicio_nivel, alertas, ativo)
               VALUES (?, ?, ?, ?, ?, ?, ?, 1)""",
            (
...
def excluir_colaborador_definitivo(colaborador_id: str):
    """Exclui o colaborador e remove suas avaliações de campo e mensais de forma definitiva (física)."""
    with get_conn() as conn:
        # Remove registros dependentes para garantir integridade e evitar erros de chave estrangeira
        conn.execute("DELETE FROM avaliacoes_campo WHERE colaborador_id = ?", (colaborador_id,))
        conn.execute("DELETE FROM avaliacoes_mensais WHERE colaborador_id = ?", (colaborador_id,))
        # Remove o colaborador definitivamente
        conn.execute("DELETE FROM colaboradores WHERE id = ?", (colaborador_id,))


def usuario_vinculado_a_colaborador(colaborador_id: str) -> Optional[dict]:
    """Retorna o usuário (login) vinculado a este colaborador, se existir —
    usado para alertar o RH antes de uma exclusão definitiva, já que apagar
    o colaborador não remove o login associado (ele fica sem perfil)."""
    with get_conn() as conn:
        row = conn.execute(
            "SELECT * FROM usuarios WHERE colaborador_id = ?", (colaborador_id,)
        ).fetchone()
    if not row:
        return None
...
def salvar_perfil_comportamental(colaborador_id, dominio_principal, top_talentos, pontos_desenvolvimento, narrativa_ia=None):
    with get_conn() as conn:
        conn.execute(
            """INSERT INTO perfis_comportamentais (colaborador_id, data_teste, dominio_principal, top_talentos, pontos_desenvolvimento, narrativa_ia)
               VALUES (?, ?, ?, ?, ?, ?)
               ON CONFLICT(colaborador_id) DO UPDATE SET
                 data_teste=excluded.data_teste, dominio_principal=excluded.dominio_principal,
                 top_talentos=excluded.top_talentos, pontos_desenvolvimento=excluded.pontos_desenvolvimento, narrativa_ia=excluded.narrativa_ia""",
            (colaborador_id, datetime.now().isoformat(), dominio_principal, _dumps(top_talentos), _dumps(pontos_desenvolvimento), narrativa_ia)
        )


def obter_perfil_comportamental(colaborador_id) -> Optional[dict]:
    with get_conn() as conn:
        row = conn.execute("SELECT * FROM perfis_comportamentais WHERE colaborador_id = ?", (colaborador_id,)).fetchone()
    if row:
        return {
            "colaborador_id": row["colaborador_id"], "data_teste": row["data_teste"], "dominio_principal": row["dominio_principal"],
            "top_talentos": _loads(row["top_talentos"]), "pontos_desenvolvimento": _loads(row["pontos_desenvolvimento"]), "narrativa_ia": row["narrativa_ia"]
        }
    return None


def salvar_pdi_emitido(colaborador_id, periodo, nota_final, media_parte_a, media_parte_b, compilado, plano, emitido_por=None):
    """Grava o PDI oficial emitido pelo RH/Head para um colaborador num
    período. É o documento único daquele mês: o colaborador não gera o
    seu próprio, apenas baixa este mesmo. Emitir de novo substitui o
    anterior (mesma chave colaborador_id + periodo)."""
    with get_conn() as conn:
        conn.execute(
            """INSERT INTO pdis_emitidos (colaborador_id, periodo, data_emissao, emitido_por, nota_final, media_parte_a, media_parte_b, compilado, plano)
               VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
               ON CONFLICT(colaborador_id, periodo) DO UPDATE SET
                 data_emissao=excluded.data_emissao, emitido_por=excluded.emitido_por,
                 nota_final=excluded.nota_final, media_parte_a=excluded.media_parte_a,
                 media_parte_b=excluded.media_parte_b, compilado=excluded.compilado, plano=excluded.plano""",
            (colaborador_id, periodo, datetime.now().isoformat(), emitido_por, float(nota_final),
             media_parte_a, media_parte_b, _dumps(compilado), _dumps(plano)),
        )


def obter_pdi_emitido(colaborador_id: str, periodo: str) -> Optional[dict]:
    with get_conn() as conn:
        row = conn.execute(
            "SELECT * FROM pdis_emitidos WHERE colaborador_id = ? AND periodo = ?",
    ...
    return {
        ...
        "compilado": _loads(row["compilado"]),
        "plano": _loads(row["plano"]),
    }


def construir_pdf_pdi_emitido(registro: dict, colaborador: dict) -> tuple:
    """Reconstrói o PDF exatamente a partir do PDI oficial gravado — como
    todo o conteúdo veio do banco (e não de uma nova chamada à IA), o
    arquivo sai idêntico para quem quer que o baixe: RH, Head ou o próprio
    colaborador. Devolve (nome_do_arquivo, bytes_do_pdf)."""
    ficha_para_pdf = None
    if registro["media_parte_a"] is not None or registro["media_parte_b"] is not None:
        ficha_para_pdf = {
            "media_parte_a": registro["media_parte_a"] or 0.0,
            "media_parte_b": registro["media_parte_b"] or 0.0,
        }
    nome_arquivo = f"PDI_{colaborador['nome'].replace(' ', '_')}_{registro['periodo']}.pdf"
    caminho = os.path.join(PASTA_PDIS, nome_arquivo)
    gerar_pdf_pdi(
        caminho, colaborador["nome"], colaborador["cargo"], registro["periodo"],
        registro["nota_final"], registro["compilado"], ficha_para_pdf, registro["plano"],
    )
    with open(caminho, "rb") as f:
        return nome_arquivo, f.read()


def listar_todos_perfis_consolidados() -> list[dict]:
    """Cruza perfis comportamentais com área/cargo dos colaboradores ativos
    — usado no relatório macro de RH. top_talentos e pontos_desenvolvimento
    já saem parseados (listas), prontos para uso no Pandas."""
    with get_conn() as conn:
        rows = conn.execute(
            """SELECT c.nome, c.area, c.cargo, p.dominio_principal, p.top_talentos, p.pontos_desenvolvimento
               FROM perfis_comportamentais p
    ...
    return [
        {
            ...
            "area": r["area"],
            "cargo": r["cargo"],
            "dominio_principal": r["dominio_principal"],
            "top_talentos": _loads(r["top_talentos"]),
            "pontos_desenvolvimento": _loads(r["pontos_desenvolvimento"]),
        }
        for r in rows
    ]
...
# ---------------------------------------------------------------------------
# CRUD — Avaliações de Entrega Técnica (Camada 2)
# ---------------------------------------------------------------------------
...
def excluir_avaliacao_campo(avaliacao_id: str):
    with get_conn() as conn:
        conn.execute("DELETE FROM avaliacoes_campo WHERE id = ?", (avaliacao_id,))
...
def excluir_avaliacao_mensal(avaliacao_id: str):
    with get_conn() as conn:
        conn.execute("DELETE FROM avaliacoes_mensais WHERE id = ?", (avaliacao_id,))
...
def atualizar_senha_usuario(usuario_id: str, nova_senha: str):
    with get_conn() as conn:
        conn.execute(
...
def atualizar_email_usuario(usuario_id: str, novo_email: str):
    with get_conn() as conn:
        conn.execute(
            "UPDATE usuarios SET email = ? WHERE id = ?",
            (novo_email.strip().lower(), usuario_id),
        )
...
def formatar_tempo_anos_meses(total_meses: int) -> str:
    """Converte um total de meses em texto legível, ex.: '1 ano e 4 meses'."""
    anos, meses = divmod(max(total_meses, 0), 12)
    partes = []
    if anos > 0:
...
def formatar_periodo_extenso(periodo_str: str) -> str:
    """Converte 'AAAA-MM' para 'Mês/AAAA' por extenso, ex.: '2026-09' -> 'Setembro/2026'."""
    try:
        ano, mes = periodo_str.split("-")
        nome_mes = MESES_PT_NOMES.get(int(mes), mes)
...
# ---------------------------------------------------------------------------
# Camada 2 — Avaliação de Entrega Técnica (campo)
# ---------------------------------------------------------------------------
...
def nota_consolidada_periodo(nota_mensal: Optional[float], notas_campo: list[float]) -> dict:
    ...
    de Entrega Técnica lançadas no mesmo período de apuração.
...
def calcular_resultado_comportamental(respostas_brutas: dict) -> dict:
    """Processa as respostas do inventário ipsativo de 30 situações e
    devolve o domínio predominante, o Top 5 de talentos e as 5 maiores
    oportunidades de desenvolvimento.

    respostas_brutas: {"tela_01": {"A": nota, "B": nota, "C": nota}, ...}
    onde nota é 0, 1, 3 ou 4 (escala ipsativa: 4 Muito parecido comigo,
    3 Parecido comigo, 1 Pouco parecido comigo, 0 Nada parecido comigo)."""
    pontos_talentos = {t: 0.0 for lista in MAPEAMENTO_DOMINIOS.values() for t in lista}
    for tela_id, escolhas in respostas_brutas.items():
        if tela_id in MATRIZ_TESTE_COMPORTAMENTAL:
            config_tela = MATRIZ_TESTE_COMPORTAMENTAL[tela_id]
            for letra, nota in escolhas.items():
                if letra in config_tela:
                    for talento, peso in config_tela[letra]["pesos"].items():
                        if talento in pontos_talentos:
                            pontos_talentos[talento] += float(nota * peso)

    pontos_dominios = {dom: sum(pontos_talentos[t] for t in lista) for dom, lista in MAPEAMENTO_DOMINIOS.items()}
    dominio_principal = max(pontos_dominios, key=pontos_dominios.get)

    # Ordena pela pontuação (x[1]) — não pela tupla inteira, senão a
    # ordenação fica alfabética pelo nome do talento em vez de por pontos.
    ranking = sorted(pontos_talentos.items(), key=lambda x: x[1], reverse=True)
    top_5 = [{"talento": t, "pontos": int(p)} for t, p in ranking[:5]]
    oportunidades = [t for t, p in ranking[-5:]]

    return {
        "dominio_principal": dominio_principal,
        "top_talentos": top_5,
        "pontos_desenvolvimento": oportunidades,
    }
...
# ---------------------------------------------------------------------------
# PDI consolidado por mês — Opção A de fechamento mensal unificado. Em vez
# de gerar uma ação de IA por critério isolado, o sistema compila TODO o
# mês (todas as Avaliações de Entrega Técnica + a Ficha Mensal + o Perfil) e
# gera um único plano de desenvolvimento unificado.
# ---------------------------------------------------------------------------

def montar_compilado_mensal(ficha_mensal, campo_periodo: list) -> dict:
    """Consolida as Avaliações de Entrega Técnica do mês com a Ficha Mensal, extraindo
    a média de campo do período e as listas de KPIs/critérios com nota
    baixa (1 ou 2) de cada frente, com as respectivas justificativas."""
    notas_campo = [a["media"] for a in campo_periodo]
    media_campo_mes = sum(notas_campo) / len(notas_campo) if notas_campo else 0.0

    kpis_baixos_campo = []
    comentarios_campo = []
    for avaliacao in campo_periodo:
        itens = avaliacao.get("itens", {})
        comentarios = avaliacao.get("comentarios", {})
        textos = avaliacao.get("textos", {})
        for item_id, nota in itens.items():
            if nota is not None and nota <= 2:
                titulo = textos.get(item_id, {}).get("titulo", item_id)
                kpis_baixos_campo.append(titulo)
                texto_comentario = (comentarios or {}).get(item_id, "").strip()
                if texto_comentario:
                    comentarios_campo.append(f"{titulo} ({avaliacao.get('projeto', '')}): {texto_comentario}")
    ...
    comentarios_mensal = []
    if ficha_mensal:
        for pilar, nota in (ficha_mensal.get("notas_parte_a") or {}).items():
            if nota is not None and nota <= 2:
                kpis_baixos_mensal.append(pilar)
                kpis_baixos_parte_a.append(pilar)
                texto_comentario = (ficha_mensal.get("comentarios_parte_a") or {}).get(pilar, "").strip()
                if texto_comentario:
                    comentarios_mensal.append(f"{pilar}: {texto_comentario}")
        for valor, nota in (ficha_mensal.get("notas_parte_b") or {}).items():
            if nota is not None and nota <= 2:
                kpis_baixos_mensal.append(valor)
                kpis_baixos_parte_b.append(valor)
                texto_comentario = (ficha_mensal.get("comentarios_parte_b") or {}).get(valor, "").strip()
                if texto_comentario:
                    comentarios_mensal.append(f"{valor}: {texto_comentario}")

    return {
        "media_campo_mes": media_campo_mes,
        "kpis_baixos_campo": kpis_baixos_campo,
        "comentarios_campo": comentarios_campo,
        "kpis_baixos_mensal": kpis_baixos_mensal,
        "kpis_baixos_parte_a": kpis_baixos_parte_a,
        "kpis_baixos_parte_b": kpis_baixos_parte_b,
        "comentarios_mensal": comentarios_mensal,
    }


PLANO_MENSAL_CHAVES_OBRIGATORIAS = (
    "resultado_periodo",
    "pontos_positivos",
    "pontos_desenvolvimento",
    "plano_acao",
    "indicadores_evolucao",
    "expectativa_proximo_ciclo",
)

# Seção 7 do PDI é institucional e fixa (não é gerada pela IA): quem
# acompanha, por quanto tempo e com base em quais fontes.
# Títulos dos eixos usados apenas para renderizar PDIs emitidos no formato
# anterior (mantido para não quebrar documentos já oficializados).
EIXOS_PDI_TITULOS_LEGADO = {
    1: "EIXO I — EFICIÊNCIA TÉCNICA E LOGÍSTICA DE CAMPO",
    2: "EIXO II — GOVERNANÇA OPERACIONAL E AUTONOMIA",
    3: "EIXO III — ENGAJAMENTO CULTURAL E VALORES",
}

PDI_ACOMPANHAMENTO_FIXO = {
    "periodo": "Próximo ciclo de avaliação.",
    "fontes": [
        "Avaliação de Entrega Técnica",
        "Avaliação de Desempenho e Governança",
        "Avaliação de Cultura e Valores",
        "Feedback da liderança",
        "Evidências registradas durante o período",
    ],
    "responsaveis": ["Liderança direta", "RH"],
}


def _validar_plano_mensal(parsed: dict) -> bool:
    """Confere o contrato do PDI antes de gravar: as 6 chaves da IA, os
    limites de quantidade (máx. 3 pontos positivos, máx. 3 pontos de
    desenvolvimento, máx. 3 ações) e os campos de cada linha das tabelas.
    Os indicadores devem vir amarrados a um ponto de desenvolvimento."""
    try:
        if not all(k in parsed for k in PLANO_MENSAL_CHAVES_OBRIGATORIAS):
            return False
        if len(parsed["pontos_positivos"]) > 3:
            return False
        if not (1 <= len(parsed["pontos_desenvolvimento"]) <= 3):
            return False
        if not (1 <= len(parsed["plano_acao"]) <= 3):
            return False
        for p in parsed["pontos_positivos"]:
            if not all(k in p for k in ("titulo", "descricao")):
                return False
        for p in parsed["pontos_desenvolvimento"]:
            if not all(k in p for k in ("ponto", "o_que_foi_identificado", "o_que_precisa_mudar")):
                return False
        for a in parsed["plano_acao"]:
            if not all(k in a for k in ("desenvolvimento", "acao_pratica", "aplicacao", "acompanhamento")):
                return False
        if not parsed["indicadores_evolucao"]:
            return False
        for i in parsed["indicadores_evolucao"]:
            if not all(k in i for k in ("ponto", "indicador")):
                return False
        return True
...
def _plano_mensal_offline(compilado: dict, nome_colab: str = "o colaborador", ficha_mensal=None) -> dict:
    """Fallback offline no mesmo contrato do modo online. Só afirma o que
    os dados permitem: usa os critérios que efetivamente ficaram abaixo do
    esperado, sem inventar causa, intenção ou comportamento. Agrupa por
    dimensão de avaliação (Entrega Técnica, Desempenho e Governança,
    Cultura e Valores) em vez de criar um plano por critério."""
    campo = compilado["kpis_baixos_campo"]
    parte_a = compilado["kpis_baixos_parte_a"]
    parte_b = compilado["kpis_baixos_parte_b"]
    media_a = ficha_mensal["media_parte_a"] if ficha_mensal else None
    media_b = ficha_mensal["media_parte_b"] if ficha_mensal else None

    pontos_desenvolvimento, indicadores = [], []
    if campo:
        pontos_desenvolvimento.append({
            "ponto": "Preparação e Execução Técnica",
            "o_que_foi_identificado": (
                f"<b>Nota de Entrega Técnica: {compilado['media_campo_mes']:.2f}/5,0.</b> As Avaliações de "
                f"Entrega Técnica do período registraram resultado abaixo do esperado em: "
                f"<b>{', '.join(campo[:4])}</b>."
            ),
            "o_que_precisa_mudar": (
                "Espera-se maior consistência no cumprimento dos critérios técnicos da função, com atenção "
                "específica aos itens apontados acima."
            ),
        })
        indicadores.append({
            "ponto": "Preparação e Execução Técnica",
            "indicador": (
                f"<b>Evolução da nota dos critérios {', '.join(campo[:2])} na próxima Avaliação de "
                f"Entrega Técnica.</b>"
            ),
        })
    if parte_a:
        pontos_desenvolvimento.append({
            "ponto": "Desempenho e Governança",
            "o_que_foi_identificado": (
                (f"<b>Nota de Desempenho e Governança: {media_a:.2f}/5,0.</b> " if media_a is not None else "")
                + f"A avaliação registrou resultado abaixo do esperado em: <b>{', '.join(parte_a[:4])}</b>."
            ),
            "o_que_precisa_mudar": (
                "Espera-se a condução das responsabilidades no nível esperado para o cargo atual nos "
                "critérios apontados."
            ),
        })
        indicadores.append({
            "ponto": "Desempenho e Governança",
            "indicador": (
                f"<b>Evolução da nota de {', '.join(parte_a[:2])} na próxima Avaliação de Desempenho e "
                f"Governança</b>, acompanhada pela redução da necessidade de direcionamento constante."
            ),
        })
    if parte_b:
        pontos_desenvolvimento.append({
            "ponto": "Cultura e Valores",
            "o_que_foi_identificado": (
                (f"<b>Nota de Cultura e Valores: {media_b:.2f}/5,0.</b> " if media_b is not None else "")
                + f"A avaliação registrou resultado abaixo do esperado em: <b>{', '.join(parte_b[:4])}</b>."
            ),
            "o_que_precisa_mudar": (
                "Espera-se a demonstração prática desses valores no dia a dia, principalmente na qualidade "
                "da entrega e na comunicação transparente de erros e dificuldades."
            ),
        })
        indicadores.append({
            "ponto": "Cultura e Valores",
            "indicador": (
                f"<b>Evolução da nota de {', '.join(parte_b[:2])} na próxima Avaliação de Cultura e "
                f"Valores</b>, observando a qualidade da entrega e a comunicação transparente."
            ),
        })
    if not pontos_desenvolvimento:
        pontos_desenvolvimento.append({
            "ponto": "Resultado consolidado do período",
            "o_que_foi_identificado": (
                "A nota consolidada do período ficou abaixo do mínimo esperado, sem que um critério "
                "isolado concentrasse o resultado."
            ),
            "o_que_precisa_mudar": (
                "Revisar com a liderança, na reunião de acompanhamento, quais critérios devem ser "
                "priorizados no próximo ciclo."
            ),
        })
        indicadores.append({
            "ponto": "Resultado consolidado do período",
            "indicador": (
                f"<b>Nota consolidada do próximo período igual ou superior a "
                f"{NOTA_MINIMA_ELEGIVEL:.1f}/5,0.</b>"
            ),
        })

    acompanhamento_por_ponto = {
        "Preparação e Execução Técnica": "Avaliação de Entrega Técnica",
        "Desempenho e Governança": "Avaliação de Desempenho e Governança",
        "Cultura e Valores": "Avaliação de Cultura e Valores",
    }
    plano_acao = [
        {
            "desenvolvimento": p["ponto"],
            "acao_pratica": (
                "Alinhar com a liderança direta o padrão esperado para os critérios apontados e aplicá-lo "
                "nas atividades do período."
            ),
            "aplicacao": "Em todas as entregas relacionadas à função durante o próximo ciclo.",
            "acompanhamento": acompanhamento_por_ponto.get(p["ponto"], "Avaliação mensal e feedback da liderança"),
        }
        for p in pontos_desenvolvimento[:3]
    ]

    linha_medias = f"<b>Nota de Entrega Técnica: {compilado['media_campo_mes']:.2f}/5,0.</b>"
    if media_a is not None:
        linha_medias += f" <b>Desempenho e Governança: {media_a:.2f}/5,0.</b>"
    if media_b is not None:
        linha_medias += f" <b>Cultura e Valores: {media_b:.2f}/5,0.</b>"

    return {
        "resultado_periodo": (
            f"{linha_medias} O resultado consolidado do período ficou abaixo do mínimo de "
            f"<b>{NOTA_MINIMA_ELEGIVEL:.1f}/5,0</b> exigido para elegibilidade, o que motiva a abertura "
            "deste plano de desenvolvimento."
        ),
        "pontos_positivos": [],
        "pontos_desenvolvimento": pontos_desenvolvimento[:3],
        "plano_acao": plano_acao,
        "indicadores_evolucao": indicadores[:3],
        "expectativa_proximo_ciclo": (
            "Para o próximo ciclo, espera-se evolução nos critérios apontados neste plano. A evolução será "
            "verificada por meio das próximas <b>Avaliações de Entrega Técnica</b>, da <b>Avaliação de "
            "Desempenho e Governança</b>, da <b>Avaliação de Cultura e Valores</b> e das evidências "
            "registradas pela liderança durante o período."
        ),
    }


def gerar_plano_desenvolvimento_mensal(periodo_sel: str, ficha_mensal, compilado: dict, perfil, nome_colab: str = "", cargo_colab: str = "") -> dict:
    """Gera o PDI a partir dos DADOS DE DESEMPENHO do período, seguindo a
    lógica nota → evidência → ponto de desenvolvimento → ação →
    indicador. O perfil comportamental entra apenas como recurso de
    desenvolvimento, nunca como justificativa da nota. Sempre devolve o
    mesmo contrato, caindo no fallback offline se a chave não estiver
    configurada, se a resposta vier fora do contrato ou se a API falhar."""
    if not nome_colab:
        nome_colab = "o colaborador"

    if not (os.environ.get("ANTHROPIC_API_KEY", "").strip()):
        st.session_state["ultimo_erro_pdi_ia"] = "ANTHROPIC_API_KEY não está configurada neste ambiente (variável ausente ou vazia)."
        return _plano_mensal_offline(compilado, nome_colab, ficha_mensal)
    api_key = os.environ["ANTHROPIC_API_KEY"].strip()

    media_parte_a = ficha_mensal["media_parte_a"] if ficha_mensal else None
    media_parte_b = ficha_mensal["media_parte_b"] if ficha_mensal else None
    comentarios_campo = "; ".join(compilado["comentarios_campo"]) or "Nenhum comentário registrado pela liderança."
    comentarios_mensal = "; ".join(compilado["comentarios_mensal"]) or "Nenhum comentário registrado pela liderança."

    if perfil:
        bloco_perfil = (
            f"- Domínio predominante: {perfil['dominio_principal']}\n"
            f"- Talentos mais evidentes: {', '.join(t['talento'] for t in perfil['top_talentos'])}\n"
            "USO PERMITIDO: apenas como possível recurso de apoio ao desenvolvimento. "
            "É PROIBIDO usar o perfil para explicar, justificar ou diagnosticar a nota."
        )
    else:
        bloco_perfil = "- Não realizado. Não mencione perfil comportamental no documento."

    prompt_rh_senior = (
        "Você é um Analista de Desenvolvimento Humano e Organizacional da Firma Produções. Sua função é "
        "transformar os resultados das avaliações de desempenho em um Plano de Desenvolvimento Individual "
        "(PDI) claro, objetivo, transparente e aplicável. O documento será lido pelo PRÓPRIO COLABORADOR e "
        "deve fazê-lo compreender: como foi seu desempenho no período, quais pontos precisam de evolução, o "
        "que precisa fazer diferente e como sua evolução será medida no próximo ciclo.\n\n"
        "Não faça análise psicológica. Não julgue caráter, intenção ou comprometimento pessoal. Avalie "
        "comportamentos, entregas e resultados registrados nas avaliações.\n\n"
        f"[DADOS DO PERÍODO — {periodo_sel}]\n"
        f"- Colaborador: {nome_colab}\n"
        f"- Cargo / Nível: {cargo_colab or 'não informado'}\n"
        f"- Nota de Entrega Técnica (média das Avaliações de Entrega Técnica do período): {compilado['media_campo_mes']:.2f}/5,0\n"
        f"- Critérios de Entrega Técnica com nota 1 ou 2: {compilado['kpis_baixos_campo'] or 'nenhum'}\n"
        f"- Comentários da liderança nas Avaliações de Entrega Técnica: {comentarios_campo}\n"
        f"- Nota de Desempenho e Governança: {f'{media_parte_a:.2f}/5,0' if media_parte_a is not None else 'sem avaliação no período'}\n"
        f"- Critérios de Desempenho e Governança com nota 1 ou 2: {compilado['kpis_baixos_parte_a'] or 'nenhum'}\n"
        f"- Nota de Cultura e Valores: {f'{media_parte_b:.2f}/5,0' if media_parte_b is not None else 'sem avaliação no período'}\n"
        f"- Valores com nota 1 ou 2: {compilado['kpis_baixos_parte_b'] or 'nenhum'}\n"
        f"- Comentários da liderança na avaliação mensal: {comentarios_mensal}\n\n"
        f"[PERFIL COMPORTAMENTAL]\n{bloco_perfil}\n\n"
        "[REGRAS OBRIGATÓRIAS]\n"
        "1. NOMENCLATURA: use sempre 'Entrega Técnica', 'Avaliação de Entrega Técnica', 'Critérios de "
        "Entrega Técnica', 'Nota de Entrega Técnica'. NUNCA use 'pós-evento', 'avaliação pós-evento' ou "
        "'ficha pós-evento'. Use também 'Avaliação de Desempenho e Governança' e 'Avaliação de Cultura e "
        "Valores' como nomes das outras duas dimensões.\n"
        "2. LÓGICA: nota → evidência → ponto de desenvolvimento → ação → indicador. Toda recomendação deve "
        "estar ligada a um resultado observado. Não crie competências, problemas, causas, situações ou metas "
        "que não estejam sustentados pelos dados acima.\n"
        "3. FIDELIDADE: se os dados não permitirem concluir a causa de um resultado, não tente explicá-la. "
        "Nunca atribua intenção, escolha, caráter, emoção ou motivação ao colaborador.\n"
        "4. SEMPRE diferencie O QUE FOI AVALIADO, O QUE FOI IDENTIFICADO e O QUE PRECISA MUDAR. Seja "
        "factual: 'Pontualidade e Preparação: 2,0/5,0. O resultado ficou abaixo do esperado no período.' "
        "NUNCA: 'o colaborador demonstrou falta de comprometimento'.\n"
        "5. NEGRITO: marque com as tags <b> e </b> as informações que representam avaliação, resultado ou "
        "evidência objetiva — notas, critérios avaliados, resultados, principais pontos de atenção e metas "
        "objetivas. Exemplo: '<b>Autonomia: 2,0/5,0.</b>'. NUNCA coloque parágrafos inteiros em negrito e "
        "não use asteriscos de markdown.\n"
        "6. AGRUPAMENTO: não transforme todos os critérios com nota baixa em planos separados. Agrupe "
        "critérios relacionados sob um ponto de desenvolvimento (ex.: 'Preparação e Execução Técnica' pode "
        "reunir Pontualidade e Preparação + Qualidade da Execução). Máximo de 3 pontos, priorizando maior "
        "impacto na entrega, recorrência, resultado mais abaixo do esperado e possibilidade real de "
        "desenvolvimento no próximo ciclo.\n"
        "7. CULTURA E VALORES: informe corretamente os valores avaliados, mas não crie um plano por valor. "
        "Agrupe os relacionados, priorize os de maior impacto e transforme-os em comportamentos observáveis. "
        "Nunca transforme nota baixa em julgamento de caráter.\n"
        "8. GOVERNANÇA: relacione o resultado às responsabilidades esperadas para o NÍVEL ATUAL do cargo. "
        "Não compare o colaborador com níveis superiores.\n"
        "9. AÇÕES: específicas e observáveis. Evite 'melhorar a organização'; prefira 'realizar a "
        "conferência dos materiais sob sua responsabilidade antes da execução da atividade'. O campo "
        "'acompanhamento' deve dizer qual avaliação ou evidência verificará a ação.\n"
        "10. INDICADORES: um indicador objetivo POR PONTO de desenvolvimento, usando preferencialmente os "
        "mesmos critérios já existentes nas avaliações da Firma, para permitir comparação entre ciclos. "
        "Ex.: '<b>Evolução da nota de Pontualidade e Preparação e Qualidade da Execução na próxima "
        "Avaliação de Entrega Técnica.</b>'. Só estabeleça meta numérica quando houver nota de referência "
        "(ex.: 'evoluir de 2,0/5,0 para pelo menos 3,0/5,0'). Evite indicadores artificiais como 'ter duas "
        "ideias' ou 'fazer três reportes'.\n"
        "11. PONTOS POSITIVOS: no máximo 3 e apenas os sustentados pelos dados. Se não houver evidência "
        "suficiente, devolva uma lista vazia — o documento informará isso automaticamente. Não invente "
        "elogios.\n"
        "12. RESULTADO DO PERÍODO: comece informando as três médias em negrito e faça uma síntese de no "
        "máximo 1 ou 2 parágrafos respondendo 'como o colaborador performou neste ciclo?'. Sem discurso "
        "motivacional.\n"
        "13. EXPECTATIVA PARA O PRÓXIMO CICLO: conclusão curta respondendo 'o que a liderança espera "
        "observar de diferente no próximo ciclo?', citando os critérios concretos e como a evolução será "
        "verificada. Exemplo de tom: 'Para o próximo ciclo, espera-se evolução nos critérios de Entrega "
        "Técnica relacionados à preparação e execução, além de maior consistência em Autonomia e Entrega. A "
        "evolução será verificada por meio das próximas avaliações e das evidências registradas pela "
        "liderança.' Sem discurso motivacional.\n"
        "14. LINGUAGEM: direta, branda, transparente, profissional e factual. Evite textos longos, frases "
        "motivacionais e termos excessivamente psicológicos. Não explique 'quem o colaborador é'. "
        "Concentre-se em: o que aconteceu → o que precisa melhorar → o que ele deve fazer → como vamos "
        "acompanhar.\n\n"
        "[VALIDAÇÃO OBRIGATÓRIA ANTES DE RESPONDER]\n"
        "Revise mentalmente antes de gerar o JSON. DADOS: as notas citadas estão corretas? Os critérios "
        "mencionados realmente tiveram aquele resultado? As conclusões estão sustentadas pelas avaliações? "
        "DESENVOLVIMENTO: os pontos escolhidos são prioritários e compatíveis com o cargo e nível? Foi "
        "criado algum problema que não aparece nas avaliações? PLANO DE AÇÃO: cada ação responde a um ponto "
        "de desenvolvimento? O colaborador entende exatamente o que fazer? A ação pode ser observada na "
        "prática? INDICADORES: cada ponto tem forma clara de medir evolução, usando critérios já existentes "
        "na avaliação da Firma, comparáveis com o próximo ciclo? LINGUAGEM: o documento descreve "
        "comportamento e entrega, e não caráter ou intenção? Há diagnóstico psicológico, julgamento moral ou "
        "generalização a partir de uma única ocorrência? Se qualquer resposta for insatisfatória, corrija "
        "antes de responder.\n\n"
        "Ao terminar a leitura, o colaborador deve conseguir responder: como fui avaliado, onde preciso "
        "melhorar, o que preciso fazer diferente, como minha evolução será medida e o que será observado no "
        "próximo ciclo.\n\n"
        "Retorne APENAS um objeto JSON válido, sem texto antes ou depois, sem markdown, com exatamente esta estrutura:\n"
        "{\n"
        '  "resultado_periodo": "as três médias em <b></b> seguidas de síntese de 1 a 2 parágrafos",\n'
        '  "pontos_positivos": [{"titulo": "nome curto", "descricao": "o que os resultados mostram"}],\n'
        '  "pontos_desenvolvimento": [{"ponto": "nome do agrupamento", "o_que_foi_identificado": "resultado com a nota em <b></b> e os critérios envolvidos", "o_que_precisa_mudar": "comportamento ou entrega esperada"}],\n'
        '  "plano_acao": [{"desenvolvimento": "ponto que precisa evoluir", "acao_pratica": "o que fazer, específico e observável", "aplicacao": "quando/onde a ação ocorre", "acompanhamento": "qual avaliação ou evidência verificará"}],\n'
        '  "indicadores_evolucao": [{"ponto": "mesmo nome do ponto de desenvolvimento", "indicador": "o que precisa acontecer para considerarmos que evoluiu, com os critérios da Firma em <b></b>"}],\n'
        '  "expectativa_proximo_ciclo": "orientação curta e objetiva sobre o que a liderança espera ver diferente. Sem discurso motivacional."\n'
        "}"
    )
    try:
        resp = requests.post(
            ...
            json={
                ...
                "max_tokens": 8000,
                "messages": [{"role": "user", "content": prompt_rh_senior}],
            },
            timeout=240,
        )
        ...
        if _validar_plano_mensal(parsed):
            st.session_state["ultimo_erro_pdi_ia"] = None
            return parsed
        else:
            st.session_state["ultimo_erro_pdi_ia"] = (
                "A IA respondeu, mas o JSON devolvido não bateu com a estrutura esperada. "
                f"Início da resposta recebida: {texto[:500]}"
            )
    except requests.exceptions.HTTPError as e:
        corpo_resposta = ""
        try:
            corpo_resposta = e.response.text[:800]
        except Exception:
            pass
        st.session_state["ultimo_erro_pdi_ia"] = f"Erro HTTP da API Anthropic: {e}\nCorpo da resposta: {corpo_resposta}"
    except Exception as e:
        st.session_state["ultimo_erro_pdi_ia"] = f"Erro ao chamar a API Anthropic ({type(e).__name__}): {e}"
    return _plano_mensal_offline(compilado, nome_colab, ficha_mensal)


NARRATIVA_CHAVES_TALENTO = ("talento", "definicao_curta", "o_que_e", "como_aparece_em_voce", "como_pode_ser_percebido", "no_trabalho", "quando_esta_no_seu_melhor", "quando_pode_passar_do_ponto", "como_usar_melhor")
NARRATIVA_CHAVES_GAP = ("talento", "o_que_e", "o_que_pode_acrescentar", "como_pode_ser_menos_natural", "como_aparece_no_dia_a_dia", "em_quais_situacoes_e_importante", "o_que_fazer_para_desenvolver")
NARRATIVA_CHAVES_COMO_FUNCIONA = ("como_pensa", "como_age", "como_se_relaciona", "como_toma_decisoes", "como_lida_com_problemas", "como_reage_sob_pressao", "o_que_motiva", "onde_gera_mais_valor")
NARRATIVA_CHAVES_TOPO = ("frase_sintese", "talentos_predominantes", "combinacao_talentos", "como_voce_funciona", "talentos_desenvolver", "combinacao_gaps", "retrato_profissional")


def _validar_narrativa_estruturada(parsed: dict) -> bool:
    """Confere se o JSON devolvido pela IA tem exatamente as chaves e a
    forma esperadas — evita salvar no banco um resultado incompleto que
    quebraria a renderização em cards/expansíveis na tela."""
    try:
        if not all(k in parsed for k in NARRATIVA_CHAVES_TOPO):
            return False
        if len(parsed["talentos_predominantes"]) != 5 or len(parsed["talentos_desenvolver"]) != 5:
            return False
        for item in parsed["talentos_predominantes"]:
            if not all(k in item for k in NARRATIVA_CHAVES_TALENTO):
                return False
        for item in parsed["talentos_desenvolver"]:
            if not all(k in item for k in NARRATIVA_CHAVES_GAP):
                return False
        if not all(k in parsed["como_voce_funciona"] for k in NARRATIVA_CHAVES_COMO_FUNCIONA):
            return False
        return True
    except (TypeError, KeyError):
        return False
...
def _narrativa_comportamental_offline(top_talentos: list, pontos_desenvolvimento: list, dominio_principal: str) -> dict:
    """Fallback offline com a mesma estrutura rica exigida do modo online
    — usa as definições oficiais de DEFINICOES_TALENTOS como âncora, então
    nunca inventa característica sem relação com o talento. Por ser
    gerado sem IA, é necessariamente mais template-based do que a
    interpretação individualizada que o modo online produz — a
    granularidade de campos é a mesma, mas a profundidade interpretativa
    real depende da chamada à API estar disponível."""
    talentos_predominantes = []
    for item in top_talentos:
        nome = item["talento"]
        definicao = DEFINICOES_TALENTOS.get(nome, "Talento do seu perfil comportamental.")
        talentos_predominantes.append({
            "talento": nome,
            "definicao_curta": definicao,
            "o_que_e": definicao,
            "como_aparece_em_voce": (
                f"É comum que {nome.lower()} apareça na forma como você avalia uma situação antes de agir, "
                "influenciando o que você prioriza, como interpreta informações e como decide o próximo passo."
            ),
            "como_pode_ser_percebido": (
                "Para quem trabalha com você, esse comportamento costuma transmitir consistência. Em alguns "
                "momentos, porém, pode ser lido de forma diferente da intenção original, especialmente sob pressão."
            ),
            "no_trabalho": (
                "No seu dia a dia profissional, esse talento tende a aparecer tanto no planejamento quanto na "
                "execução das suas atividades, se adaptando ao contexto específico da sua função."
            ),
            "quando_esta_no_seu_melhor": (
                "Quando bem direcionado, esse talento tende a gerar resultado consistente exatamente nas situações "
                "em que você tem espaço para aplicá-lo com autonomia."
            ),
            "quando_pode_passar_do_ponto": (
                "Sob forte pressão ou em excesso, essa mesma força pode se manifestar de forma mais intensa do que "
                "o necessário, exigindo atenção consciente para se manter equilibrada."
            ),
            "como_usar_melhor": (
                f"Vale observar conscientemente as situações em que {nome.lower()} aparece com mais intensidade, "
                "e ajustar a intensidade da resposta conforme o contexto exige."
            ),
        })

    talentos_desenvolver = []
    for nome in pontos_desenvolvimento:
        definicao = DEFINICOES_TALENTOS.get(nome, "Talento do seu perfil comportamental.")
        talentos_desenvolver.append({
            "talento": nome,
            "o_que_e": definicao,
            "o_que_pode_acrescentar": (
                "Desenvolver essa competência pode ampliar seu repertório de respostas diante de situações "
                "diferentes das que você já domina naturalmente."
            ),
            "como_pode_ser_menos_natural": (
                f"Esse talento não é uma fraqueza sua — apenas uma forma de comportamento que pode exigir mais "
                "intenção e prática para se tornar consistente no seu dia a dia."
            ),
            "como_aparece_no_dia_a_dia": (
                "Pode acontecer de essa não ser sua primeira resposta natural diante de uma situação que a exige, "
                "o que é esperado quando um talento tem menor evidência no perfil."
            ),
            "em_quais_situacoes_e_importante": (
                "Em determinados momentos da rotina profissional, essa competência pode ser exigida mesmo não "
                "sendo uma força natural do seu perfil."
            ),
            "o_que_fazer_para_desenvolver": (
                "Um bom começo é observar conscientemente situações em que essa competência é necessária e "
                "praticar deliberadamente uma resposta diferente da sua tendência natural."
            ),
        })

    forcas_nomes = ", ".join(t["talento"] for t in top_talentos)
    gaps_nomes = ", ".join(pontos_desenvolvimento)

    return {
        "frase_sintese": f"Seu perfil apresenta forte predominância no Domínio de {dominio_principal}, combinando talentos que moldam sua forma natural de pensar, agir e se relacionar no trabalho.",
        "talentos_predominantes": talentos_predominantes,
        "combinacao_talentos": (
            f"Seus talentos ({forcas_nomes}) tendem a se reforçar mutuamente no dia a dia: juntos, ajudam a explicar "
            "por que você costuma responder de uma forma característica diante de demandas, pessoas e imprevistos "
            "no trabalho — não como características isoladas, mas como um conjunto que funciona de forma integrada."
        ),
        "como_voce_funciona": {
            "como_pensa": f"Sua forma de pensar tende a ser guiada pela combinação de {forcas_nomes}, moldando o que você prioriza ao avaliar uma situação.",
            "como_age": "Na prática, você tende a agir de um jeito consistente com essas forças, especialmente quando tem espaço para aplicá-las com autonomia.",
            "como_se_relaciona": "No relacionamento com a equipe, esses talentos tendem a definir o tipo de contribuição que você naturalmente oferece ao grupo.",
            "como_toma_decisoes": "Suas decisões tendem a refletir a forma como esses talentos priorizam informação, ação e recursos disponíveis.",
            "como_lida_com_problemas": "Diante de um problema, sua forma natural de resposta tende a seguir o padrão definido por essas forças predominantes.",
            "como_reage_sob_pressao": "Sob pressão, essas mesmas forças tendem a se intensificar — o que pode ser positivo, mas também exige atenção consciente.",
            "o_que_motiva": "Situações em que você pode aplicar essas forças livremente tendem a ser as que mais geram energia e motivação no seu dia a dia.",
            "onde_gera_mais_valor": "Você tende a gerar mais valor exatamente nos contextos em que essas forças podem ser aplicadas com autonomia e reconhecimento.",
        },
        "talentos_desenvolver": talentos_desenvolver,
        "combinacao_gaps": (
            f"Os talentos {gaps_nomes}, se desenvolvidos gradualmente, podem complementar suas forças predominantes, "
            "ampliando seu repertório comportamental sem que isso signifique mudar quem você é — apenas somar novas "
            "formas de responder às situações do dia a dia."
        ),
        "retrato_profissional": (
            f"No ambiente profissional, você tende a ser reconhecido pela forma como aplica {forcas_nomes} no seu "
            "trabalho — uma combinação que molda tanto a maneira como você se organiza quanto a forma como se "
            f"relaciona com a equipe ao seu redor. Sua contribuição tende a ser mais evidente exatamente nas "
            "situações em que essas forças podem ser aplicadas com autonomia e reconhecimento.\n\n"
            f"Ao mesmo tempo, vale observar os momentos em que essas mesmas forças, levadas ao extremo, podem gerar "
            "ruído com quem está ao seu redor — não porque a intenção mude, mas porque a intensidade do "
            "comportamento pode ser lida de forma diferente sob pressão.\n\n"
            f"Desenvolver gradualmente {gaps_nomes} amplia seu repertório de respostas possíveis, sem exigir que "
            "você abra mão do que já funciona bem no seu perfil — apenas somando novas formas de agir diante de "
            "situações que hoje talvez peçam mais atenção consciente de sua parte."
        ),
    }


def gerar_narrativa_comportamental(dominio_principal: str, top_talentos: list, pontos_desenvolvimento: list, cargo_colab: str = "", area_colab: str = "") -> dict:
    """Chama a API do Claude para gerar a devolutiva comportamental como
    uma INTERPRETAÇÃO individualizada (não uma definição de dicionário) —
    como cada talento tende a aparecer NAQUELA pessoa, com o mesmo padrão
    de profundidade de uma devolutiva de ferramenta profissional de
    perfil (estilo Profiler). Sempre devolve um dicionário com a mesma
    estrutura, caindo no fallback offline se a chave não estiver
    configurada, se a resposta da IA vier incompleta/repetitiva ou se a
    chamada falhar."""
    definicoes_predominantes = {t["talento"]: DEFINICOES_TALENTOS.get(t["talento"], "") for t in top_talentos}
    definicoes_gaps = {g: DEFINICOES_TALENTOS.get(g, "") for g in pontos_desenvolvimento}
    contexto_profissional = f"{cargo_colab} ({NOMES_AREAS.get(area_colab, area_colab)})" if cargo_colab else "não informado"

    api_key = os.environ.get("ANTHROPIC_API_KEY", "").strip()
    if not api_key:
        st.session_state["ultimo_erro_narrativa_ia"] = "ANTHROPIC_API_KEY não está configurada neste ambiente (variável ausente ou vazia)."
        return _narrativa_comportamental_offline(top_talentos, pontos_desenvolvimento, dominio_principal)

    prompt_devolutiva = (
        "Você é um Analista Comportamental Sênior especializado em devolutivas de ferramentas profissionais de "
        "perfil comportamental (padrão Profiler). Sua missão NÃO é definir o que cada talento significa — é "
        "INTERPRETAR como cada talento tende a se manifestar NESTA pessoa específica, de forma que ela leia e "
        "pense 'isso explica muito sobre a forma como eu funciono'.\n\n"
        "A diferença entre DEFINIÇÃO e INTERPRETAÇÃO é central para essa tarefa:\n"
        "DEFINIÇÃO (não faça isso): 'Esse talento busca dados e evidências.'\n"
        "INTERPRETAÇÃO (faça isso): 'Você tende a não aceitar uma informação apenas porque ela foi apresentada "
        "como verdade. Antes de decidir, é comum que procure entender o que está por trás dela, observe detalhes "
        "e busque elementos que confirmem se aquela conclusão realmente faz sentido. Isso pode fazer com que você "
        "seja a pessoa que identifica uma inconsistência antes dos demais.'\n\n"
        f"[DOMÍNIO PREDOMINANTE] {dominio_principal}\n"
        f"[CARGO / ÁREA DO COLABORADOR] {contexto_profissional}\n"
        "Adapte os exemplos profissionais a esse contexto real: se for operacional, use exemplos de operação, "
        "evento, montagem, execução, equipamento, cliente e equipe quando fizer sentido; se for backoffice, use "
        "processos, análise, comunicação, organização, decisões e relacionamento interno; se for liderança, use "
        "gestão de pessoas, direcionamento, decisões e acompanhamento. Não use 'na Firma' de forma genérica e "
        "repetitiva — varie a forma de trazer o contexto profissional.\n\n"
        "[OS 5 TALENTOS PREDOMINANTES E SUAS DEFINIÇÕES OFICIAIS — use esse significado como base da sua "
        "interpretação, nunca invente característica fora dele]\n"
        + "\n".join(f"- {nome}: {definicao}" for nome, definicao in definicoes_predominantes.items()) + "\n\n"
        "[OS 5 TALENTOS PARA DESENVOLVER E SUAS DEFINIÇÕES OFICIAIS]\n"
        + "\n".join(f"- {nome}: {definicao}" for nome, definicao in definicoes_gaps.items()) + "\n\n"
        "[REGRAS OBRIGATÓRIAS DE REDAÇÃO]\n"
        "- Escreva em segunda pessoa ('Você tende a...', 'É comum que você...', 'Provavelmente percebe...'). Evite afirmações absolutas — use expressões que indicam tendência, não certeza.\n"
        "- Cada talento deve ter uma narrativa PRÓPRIA e individualizada. Não repita as mesmas frases-modelo entre talentos diferentes (por exemplo, não comece a explicação de todos os talentos da mesma forma).\n"
        "- Use apenas os talentos e definições fornecidos. Não crie talentos novos, não altere nomes, não crie categorias comportamentais novas.\n"
        "- Não trate o resultado como diagnóstico psicológico e não afirme que o perfil determina a personalidade da pessoa.\n"
        "- Nunca use os termos 'fraqueza', 'defeito', 'deficiência' ou 'ponto negativo' para os talentos a desenvolver — deixe claro que menor evidência não é incapacidade, apenas exige mais prática consciente.\n"
        "- No excesso de uma força predominante, explique a diferença entre força equilibrada e excesso sob pressão, sem chamar de defeito e sem fazer diagnóstico.\n"
        "- Seja específico: em vez de 'gera resultados com naturalidade', explique QUAL resultado e POR QUÊ. Em vez de conselhos genéricos, dê orientações práticas específicas para aquele talento.\n"
        "- No retrato profissional final, não comece com 'Seu perfil demonstra...' e evite clichês como 'você é único' ou 'seu potencial é ilimitado'.\n\n"
        "Antes de finalizar cada campo, verifique mentalmente: isso é uma definição de dicionário ou uma interpretação real desta pessoa? Mostrei comportamento observável, não só o nome do talento? Evitei repetir a mesma estrutura de frase usada em outro talento?\n\n"
        "Retorne APENAS um objeto JSON válido, sem texto antes ou depois, sem markdown, com exatamente esta estrutura:\n"
        "{\n"
        '  "frase_sintese": "frase curta sobre a característica central do perfil",\n'
        '  "talentos_predominantes": [\n'
        '    {"talento": "nome exato", "definicao_curta": "frase curta pro card",\n'
        '     "o_que_e": "explicação curta e clara do talento (definição, pode ser breve aqui)",\n'
        '     "como_aparece_em_voce": "INTERPRETAÇÃO de como esse talento influencia a forma de pensar, perceber, agir, decidir, resolver problemas e se relacionar NESTA pessoa — o campo mais importante, denso e específico",\n'
        '     "como_pode_ser_percebido": "como colegas/liderança/clientes/equipe podem perceber esse comportamento — tanto a leitura positiva quanto a possível interpretação equivocada",\n'
        '     "no_trabalho": "aplicação real no contexto de cargo/área informado, sem genérico",\n'
        '     "quando_esta_no_seu_melhor": "qual resultado específico esse talento gera quando bem utilizado, e por quê",\n'
        '     "quando_pode_passar_do_ponto": "diferença entre força equilibrada e excesso sob pressão, sem chamar de defeito",\n'
        '     "como_usar_melhor": "orientação prática e específica, não genérica"},\n'
        "    ... (exatamente 5 objetos, um por talento predominante, na ordem dada, cada um com redação própria)\n"
        "  ],\n"
        '  "combinacao_talentos": "interpretação de como os 5 talentos predominantes funcionam JUNTOS: o que a combinação revela, como a pessoa inicia tarefas, lida com problemas, toma decisões, interage com pessoas, o que a motiva, como contribui pra equipe, o que acontece sob pressão, quais talentos se fortalecem mutuamente e quais tensões podem existir entre eles — não repita as definições isoladas",\n'
        '  "como_voce_funciona": {"como_pensa": "...", "como_age": "...", "como_se_relaciona": "...", "como_toma_decisoes": "...", "como_lida_com_problemas": "...", "como_reage_sob_pressao": "...", "o_que_motiva": "...", "onde_gera_mais_valor": "..."} (cada campo derivado da combinação dos 5 talentos, não genérico),\n'
        '  "talentos_desenvolver": [\n'
        '    {"talento": "nome exato",\n'
        '     "o_que_e": "explicação curta do talento",\n'
        '     "o_que_pode_acrescentar": "o que desenvolver isso soma ao perfil",\n'
        '     "como_pode_ser_menos_natural": "deixando claro que não é fraqueza, apenas exige mais prática",\n'
        '     "como_aparece_no_dia_a_dia": "usando \'pode acontecer de...\', \'em algumas situações...\', sem afirmar como certeza",\n'
        '     "em_quais_situacoes_e_importante": "contexto de trabalho real em que esse talento é exigido",\n'
        '     "o_que_fazer_para_desenvolver": "comportamento prático e específico, não genérico"},\n'
        "    ... (exatamente 5 objetos, um por talento a desenvolver, na ordem dada, cada um com redação própria)\n"
        "  ],\n"
        '  "combinacao_gaps": "interpretação de como os 5 talentos a desenvolver, em conjunto, podem ampliar e complementar os talentos predominantes — o que muda na atuação da pessoa se ela desenvolver essas capacidades",\n'
        '  "retrato_profissional": "4 a 6 parágrafos: quem é essa pessoa no ambiente profissional, como funciona, como contribui, como se relaciona, principais forças, cuidados necessários e o que pode desenvolver — não comece com \'Seu perfil demonstra\' e evite clichês"\n'
        "}"
    )
    try:
        resp = requests.post(
            ...
            json={
                "model": ANTHROPIC_MODEL,
                "max_tokens": 16000,
                "messages": [{"role": "user", "content": prompt_devolutiva}],
            },
            timeout=300,
        )
        resp.raise_for_status()
        ...
        texto = texto.replace("```json", "").replace("```", "").strip()
        parsed = json.loads(texto)
        if _validar_narrativa_estruturada(parsed):
            st.session_state["ultimo_erro_narrativa_ia"] = None
            return parsed
        else:
            st.session_state["ultimo_erro_narrativa_ia"] = (
                "A IA respondeu, mas o JSON devolvido não bateu com a estrutura esperada "
                "(faltou alguma chave obrigatória ou a quantidade de talentos não foi 5+5). "
                f"Início da resposta recebida: {texto[:500]}"
            )
    except requests.exceptions.HTTPError as e:
        corpo_resposta = ""
        try:
            ...
            pass
        st.session_state["ultimo_erro_narrativa_ia"] = f"Erro HTTP da API Anthropic: {e}\nCorpo da resposta: {corpo_resposta}"
    except Exception as e:
        st.session_state["ultimo_erro_narrativa_ia"] = f"Erro ao chamar a API Anthropic ({type(e).__name__}): {e}"
    return _narrativa_comportamental_offline(top_talentos, pontos_desenvolvimento, dominio_principal)
...
def _sanitizar_para_pdf(valor):
    """Deixa o texto seguro para o ReportLab, que interpreta o conteúdo do
    Paragraph como XML: um '&' ou '<' solto vindo do texto da IA quebraria
    a geração do PDF. Escapa tudo e devolve apenas as tags de formatação
    permitidas (<b> e <i>), que são as que o prompt autoriza usar."""
    if isinstance(valor, dict):
        return {k: _sanitizar_para_pdf(v) for k, v in valor.items()}
    if isinstance(valor, list):
        return [_sanitizar_para_pdf(v) for v in valor]
    if not isinstance(valor, str):
        return valor
    texto = valor.replace("&", "&amp;").replace("<", "&lt;").replace(">", "&gt;")
    for tag in ("b", "i"):
        texto = texto.replace(f"&lt;{tag}&gt;", f"<{tag}>").replace(f"&lt;/{tag}&gt;", f"</{tag}>")
    return texto
...
def gerar_pdf_pdi(
    ...
    nota_final: float,
    compilado: dict,
    ficha_mensal: Optional[dict],
    plano: dict,
    cidade_uf: str = "Fortaleza - CE",
) -> str:
    plano = _sanitizar_para_pdf(plano)
    ...
    # Tipografia ABNT: Times New Roman 12, entrelinha 1,5 (leading 18),
    # texto justificado e recuo de primeira linha de 1,25 cm. As margens
    # superior/inferior ficam um pouco maiores que o padrão ABNT para não
    # invadir o papel timbrado (logo no topo e rodapé institucional).
    titulo_style = ParagraphStyle(
        "TituloPDI", parent=styles["Title"], fontName="Times-Bold", fontSize=14,
        leading=21, spaceAfter=4, textColor=colors.HexColor("#8B0000"),
    )
    subtitulo_style = ParagraphStyle(
        "SubtituloPDI", parent=styles["Normal"], fontName="Times-Roman", fontSize=11,
        leading=16, textColor=colors.grey, spaceAfter=16, alignment=TA_CENTER,
    )
    heading_style = ParagraphStyle(
        "HeadingPDI", parent=styles["Heading2"], fontName="Times-Bold", fontSize=12,
        leading=18, spaceBefore=18, spaceAfter=8, textColor=colors.HexColor("#1A1A1A"),
    )
    body_style = ParagraphStyle(
        "BodyPDI", parent=styles["Normal"], fontName="Times-Roman", fontSize=12,
        leading=18, alignment=TA_JUSTIFY, firstLineIndent=1.25 * cm, spaceAfter=6,
    )
    # Variante sem recuo, para linhas de rótulo/dado que não são parágrafo corrido
    body_sem_recuo_style = ParagraphStyle(
        "BodySemRecuoPDI", parent=body_style, firstLineIndent=0,
    )
    bold_style = ParagraphStyle(
        "BoldPDI", parent=body_style, fontName="Times-Bold", firstLineIndent=0,
    )
    ...
    dados_cabecalho = [
        ...
        ["Período de Referência:", formatar_periodo_extenso(periodo_sel)],
        ["Aproveitamento do Período:", f"NÃO ELEGÍVEL ({nota_final:.1f} de 5.0)"],
    ]
    tabela_cabecalho = Table(dados_cabecalho, colWidths=[6.5 * cm, 8.5 * cm])
    ...
    # ---- Cabeçalho de métricas do período (mantido, são fatos, não "lista robotizada") ----
    story.append(Paragraph(
        f"<b>Média de Entrega Técnica (Campo):</b> {compilado['media_campo_mes']:.2f} / 5.0"
        + (f" &nbsp;|&nbsp; <b>Desempenho e Governança (A):</b> {ficha_mensal['media_parte_a']:.2f} / 5.0"
           f" &nbsp;|&nbsp; <b>Cultura e Valores (B):</b> {ficha_mensal['media_parte_b']:.2f} / 5.0" if ficha_mensal else ""),
        body_sem_recuo_style,
    ))
    story.append(Spacer(1, 8))

    # Estilo para o texto dentro das células das tabelas (menor, sem recuo)
    celula_style = ParagraphStyle(
        "CelulaPDI", parent=styles["Normal"], fontName="Times-Roman", fontSize=10,
        leading=13, alignment=TA_JUSTIFY, firstLineIndent=0,
    )
    celula_bold_style = ParagraphStyle("CelulaBoldPDI", parent=celula_style, fontName="Times-Bold")
    estilo_tabela_pdi = TableStyle([
    ...
    if "resultado_periodo" in plano:
        # ---- Seção 1: Resultado do período -------------------------------
        story.append(Paragraph("1. RESULTADO DO PERÍODO", heading_style))
        for paragrafo in str(plano["resultado_periodo"]).split("\n"):
            if paragrafo.strip():
                story.append(Paragraph(paragrafo.strip(), body_style))

        # ---- Seção 2: Pontos positivos -----------------------------------
        story.append(Paragraph("2. PONTOS POSITIVOS", heading_style))
        if plano.get("pontos_positivos"):
            for p in plano["pontos_positivos"]:
                story.append(Paragraph(f"<b>{p['titulo']}:</b> {p['descricao']}", body_style))
        else:
            story.append(Paragraph(
                "Não há evidência suficiente nas avaliações do período para destacar pontos positivos "
                "específicos.",
                body_style,
            ))

        # ---- Seção 3: Pontos de desenvolvimento (tabela) -----------------
        story.append(Paragraph("3. PRINCIPAIS PONTOS DE DESENVOLVIMENTO", heading_style))
        linhas_dev = [[
            Paragraph("Ponto", celula_bold_style),
            Paragraph("O que foi identificado", celula_bold_style),
            Paragraph("O que precisa mudar", celula_bold_style),
        ]]
        for p in plano["pontos_desenvolvimento"]:
            linhas_dev.append([
                Paragraph(p["ponto"], celula_style),
                Paragraph(p["o_que_foi_identificado"], celula_style),
                Paragraph(p["o_que_precisa_mudar"], celula_style),
            ])
        tabela_dev = Table(linhas_dev, colWidths=[3.5 * cm, 6 * cm, 6.5 * cm], repeatRows=1)
        tabela_dev.setStyle(estilo_tabela_pdi)
        story.append(tabela_dev)

        # ---- Seção 4: Plano de ação (tabela) -----------------------------
        story.append(Paragraph("4. PLANO DE AÇÃO", heading_style))
        linhas_acao = [[
            Paragraph("Desenvolvimento", celula_bold_style),
            Paragraph("Ação prática", celula_bold_style),
            Paragraph("Aplicação", celula_bold_style),
            Paragraph("Acompanhamento", celula_bold_style),
        ]]
        for a in plano["plano_acao"]:
            linhas_acao.append([
                Paragraph(a["desenvolvimento"], celula_style),
                Paragraph(a["acao_pratica"], celula_style),
                Paragraph(a["aplicacao"], celula_style),
                Paragraph(a["acompanhamento"], celula_style),
            ])
        tabela_acao = Table(linhas_acao, colWidths=[3.5 * cm, 6 * cm, 3 * cm, 3.5 * cm], repeatRows=1)
        tabela_acao.setStyle(estilo_tabela_pdi)
        story.append(tabela_acao)

        # ---- Seção 5: Indicadores de evolução ----------------------------
        story.append(Paragraph("5. INDICADORES DE EVOLUÇÃO", heading_style))
        for indicador in plano["indicadores_evolucao"]:
            if isinstance(indicador, dict):
                story.append(Paragraph(
                    f"<b>{indicador.get('ponto', '')}:</b> {indicador.get('indicador', '')}",
                    body_sem_recuo_style,
                ))
            else:
                # Compatibilidade com PDIs emitidos quando os indicadores
                # eram apenas uma lista de textos soltos.
                story.append(Paragraph(f"— {indicador}", body_sem_recuo_style))

        # ---- Seção 6: Expectativa para o próximo ciclo -------------------
        story.append(Paragraph("6. EXPECTATIVA PARA O PRÓXIMO CICLO", heading_style))
        story.append(Paragraph(plano["expectativa_proximo_ciclo"], body_style))

        # ---- Seção 7: Acompanhamento (institucional, fixo) ---------------
        story.append(Paragraph("7. ACOMPANHAMENTO", heading_style))
        story.append(Paragraph(
            f"<b>Período de acompanhamento:</b> {PDI_ACOMPANHAMENTO_FIXO['periodo']}", body_sem_recuo_style))
        story.append(Paragraph(
            f"<b>Fontes de acompanhamento:</b> {'; '.join(PDI_ACOMPANHAMENTO_FIXO['fontes'])}.",
            body_sem_recuo_style))
        story.append(Paragraph(
            f"<b>Responsáveis:</b> {' e '.join(PDI_ACOMPANHAMENTO_FIXO['responsaveis'])}.",
            body_sem_recuo_style))
    else:
        # Compatibilidade: PDIs emitidos no formato anterior (diagnóstico
        # integrado + 3 macro-eixos) continuam sendo renderizados como
        # foram emitidos, sem quebrar o download do documento oficial.
        story.append(Paragraph("1. ANÁLISE COMPORTAMENTAL E DIAGNÓSTICO INTEGRADO DO RH", heading_style))
        story.append(Paragraph(plano.get("diagnostico_integrado", ""), body_style))
        story.append(Spacer(1, 6))
        story.append(Paragraph("2. DIRETRIZES DE EVOLUÇÃO E ROTEIROS DE FEEDBACK (PRÓXIMOS 30 DIAS)", heading_style))
        for i in (1, 2, 3):
            story.append(Paragraph(EIXOS_PDI_TITULOS_LEGADO[i], bold_style))
            story.append(Paragraph(f"<i>Roteiro de Alinhamento:</i> {plano.get(f'eixo{i}_roteiro', '')}", body_style))
            story.append(Paragraph(f"<i>Plano de Ação:</i> {plano.get(f'eixo{i}_o_que_fazer', '')}", body_style))
            story.append(Paragraph(f"<i>Indicador de Sucesso:</i> {plano.get(f'eixo{i}_como_medir', '')}", body_style))
            story.append(Spacer(1, 8))
        story.append(Paragraph("3. ROTEIRO DE COMPROMISSO E DIRETRIZES PARA A REUNIÃO DE 1:1", heading_style))
        story.append(Paragraph(plano.get("fechamento_1a1", ""), body_style))

    story.append(Spacer(1, 6))
    story.append(Paragraph(f"{cidade_uf}, {hoje}.", body_sem_recuo_style))
...
def gerar_pdf_perfil_comportamental(
    caminho_saida: str,
    colaborador_nome: str,
    cargo_nivel: str,
    perfil: dict,
    ...
    """Gera o PDF da Avaliação Comportamental com o mesmo papel timbrado e
    a mesma tipografia ABNT do PDI (Times 12, entrelinha 1,5, justificado,
    recuo de 1,25 cm). Quando a narrativa estruturada existe, monta o
    documento completo com um bloco por talento; sem ela, gera ao menos a
    parte calculada (domínio, talentos e definições oficiais)."""
    narrativa = _sanitizar_para_pdf(narrativa) if narrativa else None
    doc = SimpleDocTemplate(
        caminho_saida,
        pagesize=A4,
        topMargin=3.4 * cm,
    ...
    styles = getSampleStyleSheet()
    titulo_style = ParagraphStyle(
        "TituloPerfil", parent=styles["Title"], fontName="Times-Bold", fontSize=14,
        leading=21, spaceAfter=4, textColor=colors.HexColor("#8B0000"),
    )
    subtitulo_style = ParagraphStyle(
        "SubtituloPerfil", parent=styles["Normal"], fontName="Times-Roman", fontSize=11,
        leading=16, textColor=colors.grey, spaceAfter=16, alignment=TA_CENTER,
    )
    heading_style = ParagraphStyle(
        "HeadingPerfil", parent=styles["Heading2"], fontName="Times-Bold", fontSize=12,
        leading=18, spaceBefore=18, spaceAfter=8, textColor=colors.HexColor("#1A1A1A"),
    )
    sub_heading_style = ParagraphStyle(
        "SubHeadingPerfil", parent=styles["Normal"], fontName="Times-Bold", fontSize=12,
        leading=18, spaceBefore=10, spaceAfter=4,
    )
    body_style = ParagraphStyle(
        "BodyPerfil", parent=styles["Normal"], fontName="Times-Roman", fontSize=12,
        leading=18, alignment=TA_JUSTIFY, firstLineIndent=1.25 * cm, spaceAfter=6,
    )
    body_sem_recuo_style = ParagraphStyle(
        "BodySemRecuoPerfil", parent=body_style, firstLineIndent=0,
    )

    story = []
    story.append(Paragraph("AVALIAÇÃO COMPORTAMENTAL", titulo_style))
    story.append(Paragraph("Mapeamento de Talentos — Firma Produções", subtitulo_style))
    ...
    dados_cabecalho = [
        ...
        ["Colaborador:", colaborador_nome],
        ["Cargo / Nível:", cargo_nivel],
        ["Domínio de Maior Destaque:", perfil["dominio_principal"]],
    ]
    tabela_cabecalho = Table(dados_cabecalho, colWidths=[6 * cm, 9 * cm])
    tabela_cabecalho.setStyle(
        TableStyle(
            [
                ("FONTNAME", (0, 0), (0, -1), "Times-Bold"),
    ...
    if narrativa:
        story.append(Paragraph(narrativa["frase_sintese"], body_style))

    # ---- 1. Principais talentos ------------------------------------------
    story.append(Paragraph("1. SEUS PRINCIPAIS TALENTOS", heading_style))
    for item in perfil["top_talentos"]:
        nome_talento = item["talento"]
        story.append(Paragraph(nome_talento, sub_heading_style))
        dados_talento = None
        if narrativa:
            dados_talento = next((t for t in narrativa["talentos_predominantes"] if t["talento"] == nome_talento), None)
        if dados_talento:
            for rotulo, chave in (
                ("O que é esse talento", "o_que_e"),
                ("Como pode aparecer em você", "como_aparece_em_voce"),
                ("Como você pode ser percebido", "como_pode_ser_percebido"),
                ("Esse talento no trabalho", "no_trabalho"),
                ("Quando essa força está no seu melhor", "quando_esta_no_seu_melhor"),
                ("Quando essa força pode passar do ponto", "quando_pode_passar_do_ponto"),
                ("Como usar melhor esse talento", "como_usar_melhor"),
            ):
                story.append(Paragraph(f"<i>{rotulo}:</i> {dados_talento[chave]}", body_style))
        else:
            story.append(Paragraph(DEFINICOES_TALENTOS.get(nome_talento, ""), body_style))

    if narrativa:
        story.append(Paragraph("2. COMO SEUS TALENTOS FUNCIONAM JUNTOS", heading_style))
        story.append(Paragraph(narrativa["combinacao_talentos"], body_style))

        story.append(Paragraph("3. COMO VOCÊ FUNCIONA NO DIA A DIA", heading_style))
        cf = narrativa["como_voce_funciona"]
        for rotulo, chave in (
            ("Como você pensa", "como_pensa"),
            ("Como você age", "como_age"),
            ("Como você se relaciona", "como_se_relaciona"),
            ("Como você toma decisões", "como_toma_decisoes"),
            ("Como você lida com problemas", "como_lida_com_problemas"),
            ("Como você reage sob pressão", "como_reage_sob_pressao"),
            ("O que tende a motivar você", "o_que_motiva"),
            ("Onde você tende a gerar mais valor", "onde_gera_mais_valor"),
        ):
            story.append(Paragraph(f"<i>{rotulo}:</i> {cf[chave]}", body_style))

    # ---- Talentos para desenvolver ---------------------------------------
    numero_secao = "4" if narrativa else "2"
    story.append(Paragraph(f"{numero_secao}. TALENTOS PARA DESENVOLVER", heading_style))
    story.append(Paragraph(
        "Menor evidência não significa incapacidade: indica competências que tendem a exigir mais "
        "atenção consciente e prática para serem utilizadas de forma consistente.",
        body_style,
    ))
    for nome_talento in perfil["pontos_desenvolvimento"]:
        story.append(Paragraph(nome_talento, sub_heading_style))
        dados_gap = None
        if narrativa:
            dados_gap = next((g for g in narrativa["talentos_desenvolver"] if g["talento"] == nome_talento), None)
        if dados_gap:
            for rotulo, chave in (
                ("O que é esse talento", "o_que_e"),
                ("O que pode acrescentar ao seu perfil", "o_que_pode_acrescentar"),
                ("Como pode ser menos natural para você", "como_pode_ser_menos_natural"),
                ("Como isso pode aparecer no dia a dia", "como_aparece_no_dia_a_dia"),
                ("Em quais situações pode ser importante", "em_quais_situacoes_e_importante"),
                ("O que fazer para desenvolver", "o_que_fazer_para_desenvolver"),
            ):
                story.append(Paragraph(f"<i>{rotulo}:</i> {dados_gap[chave]}", body_style))
        else:
            story.append(Paragraph(DEFINICOES_TALENTOS.get(nome_talento, ""), body_style))

    if narrativa:
        story.append(Paragraph("5. COMO ESSES TALENTOS PODEM AMPLIAR SEU PERFIL", heading_style))
        story.append(Paragraph(narrativa["combinacao_gaps"], body_style))

        story.append(Paragraph("6. SEU RETRATO PROFISSIONAL", heading_style))
        for paragrafo in str(narrativa["retrato_profissional"]).split("\n"):
            if paragrafo.strip():
                story.append(Paragraph(paragrafo.strip(), body_style))
...
st.markdown(
    ...
    .stTabs [data-baseweb="tab"][aria-selected="true"] {
        border-bottom: 3px solid #E12E2E !important;
    }
...
# ---------------------------------------------------------------------------
# Saudação de boas-vindas dinâmica e personalizada, no topo da página
# ---------------------------------------------------------------------------
nome_completo = usuario.get("nome", "Profissional")
primeiro_nome = nome_completo.split()[0].title()
papel_usuario = usuario.get("papel", "COLABORADOR")

# Para o Colaborador, o cargo/nível vive no registro do colaborador (não no
# login em si) — busca à parte para exibir o cargo real na saudação.
_cargo_colaborador_saudacao = ""
if papel_usuario == "COLABORADOR" and usuario.get("colaborador_id"):
    _colaborador_saudacao = obter_colaborador(usuario["colaborador_id"])
    if _colaborador_saudacao:
        _cargo_colaborador_saudacao = _colaborador_saudacao["cargo"]

titulos_boas_vindas = {
    "RH": "Administração / RH",
    "HEAD": "Head de Área",
    "PRODUTOR": "Produtor Técnico",
    "COLABORADOR": _cargo_colaborador_saudacao or "Colaborador",
}

rotulo_funcao = titulos_boas_vindas.get(papel_usuario, "Integrante do Time")

st.markdown(
    f"""
    <div style="background-color: #1A1A1A; padding: 15px; border-radius: 0; border-left: 4px solid #E12E2E; margin-bottom: 20px;">
        <h4 style="margin: 0; color: #FFFFFF;">Olá, {primeiro_nome}!</h4>
        <p style="margin: 5px 0 0 0; color: #AAAAAA; font-size: 14px;">Bem-vindo ao Portal Firma Produções &nbsp;|&nbsp; <b>Acesso: {rotulo_funcao}</b></p>
    </div>
    """,
    unsafe_allow_html=True,
)
...
def abas_visiveis_para_papel() -> list[str]:
    ...
    if papel == "HEAD":
        # Remove a aba de Entrega Técnica do escopo de qualquer Head de Área cadastrado
        return ["prontuario", "alcadas", "mensal", "historico", "pdi"]
    if papel == "PRODUTOR":
...
ESCALA_RESPOSTA_MAPEAMENTO = {
    4: "4 — Muito parecido comigo",
    3: "3 — Parecido comigo",
    2: "2 — Neutro / Indiferente",
    1: "1 — Pouco parecido comigo",
    0: "0 — Nada parecido comigo",
}


def renderizar_teste_comportamental(colaborador_id: str, cargo_colab: str = "", area_colab: str = ""):
    """Inventário ipsativo de 30 situações, em fluxo contínuo numa única
    página. Ao concluir, calcula e grava o Perfil Comportamental."""
    st.markdown("#### Mapeamento Comportamental Proprietário")
    st.caption(
        "30 situações do dia a dia de trabalho. Para cada afirmação, escolha o quanto ela "
        "é parecida com a sua forma natural de agir — não existe resposta certa ou errada."
    )

    with st.form("form_teste_comportamental"):
        respostas = {}
        for i in range(1, 31):
            tela_id = f"tela_{i:02d}"
            tela = MATRIZ_TESTE_COMPORTAMENTAL[tela_id]
            st.markdown(f"**{tela['contexto']}**")
            respostas[tela_id] = {}
            for letra in ("A", "B", "C"):
                respostas[tela_id][letra] = st.selectbox(
                    tela[letra]["texto"],
                    options=list(ESCALA_RESPOSTA_MAPEAMENTO.keys()),
                    format_func=lambda n: ESCALA_RESPOSTA_MAPEAMENTO[n],
                    key=f"comport_{tela_id}_{letra}",
                )
            st.write("")

        if st.form_submit_button("Concluir Mapeamento Comportamental", type="primary"):
            resultado = calcular_resultado_comportamental(respostas)
            with st.spinner("Calculando seu perfil e preparando a devolutiva..."):
                narrativa = gerar_narrativa_comportamental(
                    resultado["dominio_principal"],
                    resultado["top_talentos"],
                    resultado["pontos_desenvolvimento"],
                    cargo_colab,
                    area_colab,
                )
            salvar_perfil_comportamental(
                colaborador_id,
                resultado["dominio_principal"],
                resultado["top_talentos"],
                resultado["pontos_desenvolvimento"],
                json.dumps(narrativa, ensure_ascii=False),
            )
            st.rerun()


def renderizar_resultado_comportamental(
    perfil: dict,
    titulo: str = "Perfil Comportamental",
    colaborador_id: Optional[str] = None,
    cargo_colab: str = "",
    area_colab: str = "",
):
    """Renderiza a devolutiva comportamental como uma jornada de leitura
    (não um relatório corrido): visão geral, cards por talento, blocos
    expansíveis de aprofundamento, combinações e direcionamento prático.
    Quando colaborador_id é informado, mostra o botão para regenerar só o
    texto do laudo — útil para laudos gerados num formato anterior."""
    st.markdown(f"#### {titulo}")

    narrativa_bruta = perfil.get("narrativa_ia")
    narrativa = None
    if narrativa_bruta:
        try:
            candidato = json.loads(narrativa_bruta)
            if _validar_narrativa_estruturada(candidato):
                narrativa = candidato
        except (json.JSONDecodeError, TypeError):
            narrativa = None

    # ---- 1. SEU PERFIL ---------------------------------------------------
    st.info(f"**Domínio de Maior Destaque:** {perfil['dominio_principal']}")
    if narrativa:
        st.markdown(narrativa["frase_sintese"])

    # ---- 2. SEUS 5 PRINCIPAIS TALENTOS (cards com barra de intensidade) --
    st.markdown("##### Seus 5 Principais Talentos")
    maior_pontuacao = max((t["pontos"] for t in perfil["top_talentos"]), default=1) or 1
    cols_talentos = st.columns(5)
    for col, item in zip(cols_talentos, perfil["top_talentos"]):
        with col:
            with st.container(border=True):
                st.markdown(f"**{item['talento']}**")
                st.progress(min(item["pontos"] / maior_pontuacao, 1.0))
                definicao_curta = DEFINICOES_TALENTOS.get(item["talento"], "")
                if narrativa:
                    dados_talento = next((t for t in narrativa["talentos_predominantes"] if t["talento"] == item["talento"]), None)
                    if dados_talento:
                        definicao_curta = dados_talento["definicao_curta"]
                st.caption(definicao_curta)

    # ---- 3. ENTENDA CADA TALENTO (expansível) ----------------------------
    if narrativa:
        st.markdown("##### Entenda Cada Talento")
        for dados_talento in narrativa["talentos_predominantes"]:
            with st.expander(dados_talento["talento"]):
                st.markdown("**O que é esse talento**")
                st.write(dados_talento["o_que_e"])
                st.markdown("**Como esse talento pode aparecer em você**")
                st.write(dados_talento["como_aparece_em_voce"])
                st.markdown("**Como você pode ser percebido**")
                st.write(dados_talento["como_pode_ser_percebido"])
                st.markdown("**Esse talento no trabalho**")
                st.write(dados_talento["no_trabalho"])
                st.markdown("**Quando essa força está no seu melhor**")
                st.write(dados_talento["quando_esta_no_seu_melhor"])
                st.markdown("**Quando essa força pode passar do ponto**")
                st.write(dados_talento["quando_pode_passar_do_ponto"])
                st.markdown("**Como usar melhor esse talento**")
                st.write(dados_talento["como_usar_melhor"])

        # ---- 4. COMO SEUS TALENTOS FUNCIONAM JUNTOS ----------------------
        st.divider()
        st.markdown("##### Como Seus Talentos Funcionam Juntos")
        st.write(narrativa["combinacao_talentos"])

        # ---- COMO VOCÊ FUNCIONA NO DIA A DIA (5 blocos da jornada) -------
        cf = narrativa["como_voce_funciona"]
        st.markdown("##### Como Você Pensa")
        st.write(cf["como_pensa"])
        st.markdown("##### Como Você Age")
        st.write(cf["como_age"])
        st.markdown("##### Como Você Se Relaciona")
        st.write(cf["como_se_relaciona"])
        st.markdown("##### Como Você Toma Decisões")
        st.write(cf["como_toma_decisoes"])
        st.markdown("##### Como Você Lida com Desafios")
        st.write(cf["como_lida_com_problemas"])
        st.write(cf["como_reage_sob_pressao"])
        col_motiva, col_valor = st.columns(2)
        with col_motiva:
            st.markdown("**O que tende a motivar você**")
            st.write(cf["o_que_motiva"])
        with col_valor:
            st.markdown("**Onde você tende a gerar mais valor**")
            st.write(cf["onde_gera_mais_valor"])

    # ---- 6. TALENTOS PARA DESENVOLVER (cards) ----------------------------
    st.divider()
    st.markdown("##### Talentos para Desenvolver")
    st.caption("Menor evidência não significa incapacidade — apenas que a competência exige mais atenção consciente.")
    cols_gaps = st.columns(5)
    for col, talento in zip(cols_gaps, perfil["pontos_desenvolvimento"]):
        with col:
            with st.container(border=True):
                st.markdown(f"**{talento}**")
                st.caption(DEFINICOES_TALENTOS.get(talento, ""))

    # ---- 7. ENTENDA CADA TALENTO PARA DESENVOLVER (expansível) -----------
    if narrativa:
        st.markdown("##### Entenda Cada Talento para Desenvolver")
        for dados_gap in narrativa["talentos_desenvolver"]:
            with st.expander(dados_gap["talento"]):
                st.markdown("**O que é esse talento**")
                st.write(dados_gap["o_que_e"])
                st.markdown("**O que ele pode acrescentar ao seu perfil**")
                st.write(dados_gap["o_que_pode_acrescentar"])
                st.markdown("**Como essa competência pode ser menos natural para você**")
                st.write(dados_gap["como_pode_ser_menos_natural"])
                st.markdown("**Como isso pode aparecer no dia a dia**")
                st.write(dados_gap["como_aparece_no_dia_a_dia"])
                st.markdown("**Em quais situações profissionais essa competência pode ser importante**")
                st.write(dados_gap["em_quais_situacoes_e_importante"])
                st.markdown("**O que você pode fazer para desenvolvê-la**")
                st.write(dados_gap["o_que_fazer_para_desenvolver"])

        # ---- 8. COMO ESSES TALENTOS PODEM AMPLIAR SEU PERFIL -------------
        st.divider()
        st.markdown("##### Como Esses Talentos Podem Ampliar Seu Perfil")
        st.write(narrativa["combinacao_gaps"])

        # ---- 9. SEU RETRATO PROFISSIONAL ---------------------------------
        st.divider()
        st.markdown("## Seu Retrato Profissional")
        st.info(narrativa["retrato_profissional"])
    elif narrativa_bruta:
        # Laudo gravado num formato anterior (texto corrido, ou schema
        # antigo com menos campos) — mantém a leitura possível, mas
        # sinaliza que dá pra atualizar pra nova experiência clicando em
        # "Gerar Minha Avaliação Comportamental" logo abaixo.
        st.divider()
        st.markdown("##### Leitura do seu Perfil")
        st.caption("Este laudo foi gerado num formato anterior — regenere para ver a nova experiência completa por talento.")
        if isinstance(narrativa_bruta, str) and narrativa_bruta.strip().startswith("{"):
            st.caption("(Formato de dados antigo, não compatível com a leitura em cards atual.)")
        else:
            st.markdown(narrativa_bruta)

    if colaborador_id:
        st.divider()
        laudo_ja_existe = narrativa is not None

        # Download em PDF (papel timbrado + tipografia ABNT)
        try:
            colaborador_pdf = obter_colaborador(colaborador_id)
        except Exception:
            colaborador_pdf = None
        if colaborador_pdf:
            nome_arq_perfil = f"Avaliacao_Comportamental_{colaborador_pdf['nome'].replace(' ', '_')}.pdf"
            caminho_perfil = os.path.join(PASTA_PDIS, nome_arq_perfil)
            try:
                gerar_pdf_perfil_comportamental(
                    caminho_perfil, colaborador_pdf["nome"], colaborador_pdf["cargo"], perfil, narrativa,
                )
                with open(caminho_perfil, "rb") as f:
                    st.download_button(
                        "Baixar Avaliação Comportamental (PDF)",
                        data=f.read(), file_name=nome_arq_perfil, mime="application/pdf",
                        key=f"download_perfil_{colaborador_id}",
                    )
            except Exception as e:
                st.caption(f"Não foi possível gerar o PDF desta avaliação ({type(e).__name__}).")

        if not laudo_ja_existe:
            # Ainda não existe avaliação gerada: qualquer papel pode gerar
            # a primeira (e única) versão.
            if st.button("Gerar Minha Avaliação Comportamental", key=f"gerar_laudo_{colaborador_id}"):
                with st.spinner("Gerando sua avaliação comportamental..."):
                    nova_narrativa = gerar_narrativa_comportamental(
                        perfil["dominio_principal"], perfil["top_talentos"], perfil["pontos_desenvolvimento"],
                        cargo_colab, area_colab,
                    )
                    salvar_perfil_comportamental(
                        colaborador_id, perfil["dominio_principal"], perfil["top_talentos"],
                        perfil["pontos_desenvolvimento"], json.dumps(nova_narrativa, ensure_ascii=False),
                    )
                st.success("Avaliação comportamental gerada.")
                st.rerun()
        elif papel == "RH":
            # Documento único: o colaborador não refaz. Apenas o RH pode
            # substituir a avaliação já emitida, de forma deliberada.
            with st.expander("Refazer avaliação comportamental (somente RH)"):
                st.caption(
                    "A avaliação comportamental é um documento único do colaborador. "
                    "Refazer substitui a versão atual de forma definitiva."
                )
                if st.button("Refazer avaliação", key=f"refazer_laudo_{colaborador_id}"):
                    with st.spinner("Gerando uma nova avaliação comportamental..."):
                        nova_narrativa = gerar_narrativa_comportamental(
                            perfil["dominio_principal"], perfil["top_talentos"], perfil["pontos_desenvolvimento"],
                            cargo_colab, area_colab,
                        )
                    ...
                    st.success("Avaliação comportamental atualizada.")
                    st.rerun()

        # Diagnóstico temporário: mostra o motivo real de ter caído no
        # fallback offline na última tentativa de gerar a avaliação
        # (sem isso, o "except Exception: pass" escondia a causa real).
        ultimo_erro = st.session_state.get("ultimo_erro_narrativa_ia")
        if ultimo_erro:
            with st.expander("⚠️ Diagnóstico: por que caiu no fallback offline?"):
                st.code(ultimo_erro)
...
# Calculado UMA única vez por execução do script e reaproveitado em todas as
# abas abaixo (inclusive na barra lateral) — evita repetir a mesma consulta
# ao banco várias vezes por clique (o Streamlit executa o código de todas
# as abas a cada interação, não só da aba visível no momento).
COLABS_VISIVEIS = colaboradores_visiveis()
...
with st.sidebar:
    ...
    with st.expander("Trocar minha senha"):
        senha_atual_troca = st.text_input("Senha atual", type="password", key="sidebar_senha_atual")
        senha_nova_troca = st.text_input("Nova senha", type="password", key="sidebar_senha_nova")
        senha_nova_confirma = st.text_input("Confirme a nova senha", type="password", key="sidebar_senha_confirma")
        if st.button("Salvar nova senha", key="sidebar_salvar_senha"):
            usuario_atual_check = autenticar(usuario["email"], senha_atual_troca)
            if not usuario_atual_check:
                st.error("Senha atual incorreta.")
            elif not senha_nova_troca.strip():
                st.error("Digite a nova senha.")
            elif senha_nova_troca != senha_nova_confirma:
                st.error("A confirmação não bate com a nova senha.")
            else:
                atualizar_senha_usuario(usuario["id"], senha_nova_troca.strip())
    ...
    if papel in ("RH", "HEAD", "PRODUTOR"):
        ...
        colabs_para_foco = COLABS_VISIVEIS
        if colabs_para_foco:
...
TAB_SPECS = [
    ...
    ("historico", "Painel de Resultados e Ciclo de Crescimento"),
...
with abas[IDX["prontuario"]]:
    if papel == "COLABORADOR":
        ...
        if not colaborador_proprio:
            ...
            st.markdown(
                f"**Função / Nível:** {colaborador_proprio['cargo']} &nbsp;|&nbsp; "
                f"**Setor:** {NOMES_AREAS.get(colaborador_proprio['area'], colaborador_proprio['area'])} &nbsp;|&nbsp; "
                f"**Tempo de empresa:** {formatar_tempo_anos_meses(meses_entre(colaborador_proprio['data_admissao']))}",
                unsafe_allow_html=True,
            )

            st.divider()
            perfil_comportamental_proprio = obter_perfil_comportamental(colaborador_proprio["id"])
            if perfil_comportamental_proprio:
                renderizar_resultado_comportamental(perfil_comportamental_proprio, "Seu Perfil Comportamental", colaborador_proprio["id"], colaborador_proprio["cargo"], colaborador_proprio["area"])
            else:
                renderizar_teste_comportamental(colaborador_proprio["id"], colaborador_proprio["cargo"], colaborador_proprio["area"])
        ...
        if not colabs:
            ...
            for c in colabs:
                with st.expander(f"{c['nome']} — {c['cargo']} ({NOMES_AREAS.get(c['area'], c['area'])})"):
                    ...
                    st.write(f"**Tempo de empresa:** {formatar_tempo_anos_meses(meses_entre(c['data_admissao']))}")
                    st.write(f"**Tempo no nível:** {formatar_tempo_anos_meses(meses_entre(c['data_inicio_nivel']))}")
                    ...
                    st.divider()
                    perfil_comportamental_c = obter_perfil_comportamental(c["id"])
                    if perfil_comportamental_c:
                        renderizar_resultado_comportamental(perfil_comportamental_c, "Perfil Comportamental", c["id"], c["cargo"], c["area"])
                    else:
                        st.caption("Mapeamento Comportamental ainda não respondido por este colaborador.")
    ...
    with abas[IDX["pos_evento"]]:
        ...
        if not pode_lancar_pos_evento():
            ...
            if not colabs:
                ...
                itens_campo_cargo = obter_itens_campo(colaborador["area"], colaborador["cargo"])
                st.caption(f"Perguntas específicas para o cargo: {colaborador['cargo']}")
                ...
                with st.form("form_avaliacao_campo"):
                    ...
                    for item_id, item in itens_campo_cargo.items():
                        st.markdown(f"**{item['titulo']}**")
                        st.write(item["pergunta"])
                        if item.get("considerar"):
                            st.caption(f"Considerar: {item['considerar']}")
                        ...
                        textos_itens[item_id] = {"titulo": item["titulo"], "pergunta": item["pergunta"]}
                        st.write("")

                    st.markdown("**Classificação de Impacto no Cliente Final**")
                    ...
                    enviado_campo = st.form_submit_button("Registrar Avaliação de Entrega Técnica")

                    if enviado_campo:
                        erro_campo = not projeto.strip()
                        if erro_campo:
                            st.error("Informe o nome/identificação do projeto.")
                        for item_id, nota in notas_itens.items():
                            if nota <= 2 and not comentarios_itens.get(item_id, "").strip():
                                erro_campo = True
                                st.error(f"Atenção: Justificativa obrigatória para o item com nota {nota}. Descreva a evidência em campo.")
                        if not erro_campo:
        ...
        st.divider()
        st.markdown("##### Histórico de Avaliações Técnicas Realizadas")
        ids_visiveis = {c["id"] for c in COLABS_VISIVEIS}
        todas_campo = [a for a in listar_avaliacoes_campo() if a["colaborador_id"] in ids_visiveis]
        if todas_campo:
            mapa_nomes = {c["id"]: c["nome"] for c in COLABS_VISIVEIS}
            exibir_tabela(
                pd.DataFrame([
            ...
            st.caption("Nenhuma Avaliação de Entrega Técnica no seu escopo ainda.")
    ...
    with abas[IDX["mensal"]]:
        ...
        if not pode_lancar_mensal():
            ...
            if not colabs:
                ...
                col_mes_ref, col_ano_ref = st.columns(2)
                with col_mes_ref:
                    mes_ref = st.selectbox(
                        "Mês de referência", options=list(range(1, 13)),
                        format_func=lambda m: MESES_PT_NOMES[m], index=date.today().month - 1,
                        key="mensal_mes_ref",
                    )
                with col_ano_ref:
                    anos_ref_disponiveis = list(range(date.today().year - 1, date.today().year + 2))
                    ano_ref = st.selectbox(
                        "Ano de referência", options=anos_ref_disponiveis,
                        index=anos_ref_disponiveis.index(date.today().year),
                        key="mensal_ano_ref",
                    )
                ...
                if not criterios_cargo:
                    ...
                    with st.form("form_avaliacao_mensal"):
                        ...
                        enviado_mensal = st.form_submit_button("Concluir Avaliação do Colaborador")

                        if enviado_mensal:
                            erro_mensal = False
                            for pilar, nota in notas_parte_a.items():
                                if nota <= 2 and not comentarios_parte_a.get(pilar, "").strip():
                                    erro_mensal = True
                                    st.error(f"Atenção (Parte A): Justificativa obrigatória para o pilar '{pilar}' com nota {nota}.")
                            for valor, nota in notas_parte_b.items():
                                if nota <= 2 and not comentarios_parte_b.get(valor, "").strip():
                                    erro_mensal = True
                                    st.error(f"Atenção (Parte B): Justificativa obrigatória para o valor '{valor}' com nota {nota}.")
                            if not erro_mensal:
        ...
        if todas_mensais:
            ...
            exibir_tabela(
                pd.DataFrame([
                    {"Colaborador": mapa_nomes.get(m["colaborador_id"], "—"), "Período": formatar_periodo_extenso(m["periodo"]),
                     "Nota Desempenho (A)": f"{m['media_parte_a']:.2f}", "Nota Cultura (B)": f"{m['media_parte_b']:.2f}",
                     "Nota Final Mensal": f"{m['nota_final_mensal']:.2f}"}
                    for m in todas_mensais
                ])
            )
        else:
            st.caption("Nenhuma avaliação mensal no seu escopo ainda.")

# ===========================================================================
if "historico" in IDX:
    with abas[IDX["historico"]]:
        st.subheader("Painel de Resultados e Ciclo de Crescimento")
        ...
        if not colabs:
            ...
            if not periodos_disponiveis:
                ...
                periodo_sel = st.selectbox("Período de apuração", options=periodos_disponiveis, format_func=formatar_periodo_extenso, key="hist_periodo")
                ...
                if papel == "COLABORADOR" and not resultado["elegivel"]:
                    ...
                    pdi_proprio = obter_pdi_emitido(colaborador_id, periodo_sel)
                    if pdi_proprio:
                        data_emissao_fmt = pdi_proprio["data_emissao"][:10]
                        try:
                            data_emissao_fmt = date.fromisoformat(pdi_proprio["data_emissao"][:10]).strftime("%d/%m/%Y")
                        except ValueError:
                            pass
                        st.caption(f"PDI emitido pela gestão em {data_emissao_fmt}.")
                        nome_arq_proprio, bytes_proprio = construir_pdf_pdi_emitido(pdi_proprio, colaborador)
                        st.download_button("Baixar meu PDI", data=bytes_proprio, file_name=nome_arq_proprio, mime="application/pdf")
                    else:
                        st.info(
                            "Seu PDI deste período ainda não foi emitido pela gestão. "
                            "Assim que o RH ou o seu Head de Área emitir o documento, ele aparece aqui para download."
                        )

            st.divider()
            st.markdown("##### Status de Evolução de Carreira")
            eleg = checar_elegibilidade_promocao(colaborador["data_admissao"], colaborador["data_inicio_nivel"])

            st.markdown("**Acompanhamento de Ciclo e Próximas Janelas**")
            exibir_tabela(pd.DataFrame([
                {
                    "Tempo de empresa": formatar_tempo_anos_meses(eleg.tempo_empresa_meses),
                    "Tempo no nível atual": formatar_tempo_anos_meses(eleg.tempo_nivel_meses),
                    "Próxima janela formal": eleg.proxima_janela,
                }
            ]))
            ...
            if eleg.elegivel_geral:
                ...
                st.markdown("**Pré-requisitos Institucionais para Mudança de Nível**")
                st.write("Mínimo: 1 Ano de Empresa e 6 Meses de Nível com Consistência.")
            ...
            with col_h1:
                ...
                if historico_mensal:
                    exibir_tabela(pd.DataFrame([
                        {"Período": formatar_periodo_extenso(m["periodo"]), "Desempenho": f"{m['media_parte_a']:.2f}",
                         "Cultura": f"{m['media_parte_b']:.2f}", "Final": f"{m['nota_final_mensal']:.2f}"}
                        for m in historico_mensal
                    ]))
                else:
                    st.caption("Sem avaliações realizadas.")
            with col_h2:
                st.markdown("**Histórico de Avaliações Técnicas Realizadas**")
                if historico_campo:
                    exibir_tabela(pd.DataFrame([
                        {"Projeto": a["projeto"], "Data": a["data_evento"].strftime("%d/%m/%Y"), "Média": f"{a['media']:.2f}", "Impacto": NIVEIS_IMPACTO_CLIENTE[a["nivel_impacto"]]["label"]}
                        for a in historico_campo
                    ]))
                else:
                    st.caption("Sem avaliações técnicas realizadas.")
    ...
    with abas[IDX["pdi"]]:
        ...
        if not colabs:
            ...
            if not periodos_disponiveis:
                ...
                periodo_sel = st.selectbox("Período de apuração", options=periodos_disponiveis, format_func=formatar_periodo_extenso, key="pdi_periodo")
                ficha_mensal = next((m for m in historico_mensal if m["periodo"] == periodo_sel), None)
                campo_periodo = [a for a in historico_campo if a["data_evento"].strftime("%Y-%m") == periodo_sel]
                notas_campo = [a["media"] for a in campo_periodo]
                ...
                if resultado["elegivel"]:
                    ...
                    compilado = montar_compilado_mensal(ficha_mensal, campo_periodo)
                    perfil_pdi = obter_perfil_comportamental(colaborador_id)

                    st.markdown("**Compilado do Mês**")
                    c_pdi1, c_pdi2, c_pdi3 = st.columns(3)
                    c_pdi1.metric("Média de Campo no Mês", f"{compilado['media_campo_mes']:.2f}")
                    c_pdi2.metric("Nota Desempenho (A)", f"{ficha_mensal['media_parte_a']:.2f}" if ficha_mensal else "—")
                    c_pdi3.metric("Nota Cultura (B)", f"{ficha_mensal['media_parte_b']:.2f}" if ficha_mensal else "—")

                    total_kpis_baixos = len(compilado["kpis_baixos_campo"]) + len(compilado["kpis_baixos_mensal"])
                    st.markdown(f"**Critérios com nota 1 ou 2 identificados no mês: {total_kpis_baixos}**")
                    for kpi in compilado["kpis_baixos_campo"]:
                        st.write(f"- **{kpi}** — Avaliação de Entrega Técnica")
                    for kpi in compilado["kpis_baixos_mensal"]:
                        st.write(f"- **{kpi}** — Ficha Mensal")

                    pdi_emitido = obter_pdi_emitido(colaborador_id, periodo_sel)
                    if pdi_emitido:
                        data_emissao_fmt = pdi_emitido["data_emissao"][:10]
                        try:
                            data_emissao_fmt = date.fromisoformat(pdi_emitido["data_emissao"][:10]).strftime("%d/%m/%Y")
                        except ValueError:
                            pass
                        st.success(
                            f"PDI oficial já emitido em {data_emissao_fmt}"
                            + (f" por {pdi_emitido['emitido_por']}." if pdi_emitido.get("emitido_por") else ".")
                            + " Este é o documento que o colaborador vê no histórico dele."
                        )
                        nome_arq_emitido, bytes_emitido = construir_pdf_pdi_emitido(pdi_emitido, colaborador)
                        st.download_button("Baixar PDI emitido", data=bytes_emitido, file_name=nome_arq_emitido, mime="application/pdf")
                        with st.expander("Emitir novamente (substitui o documento atual)"):
                            st.caption(
                                "Gera um novo texto com a IA e substitui o PDI oficial deste período. "
                                "O colaborador passará a ver a nova versão no lugar da anterior."
                            )
                            if st.button("Emitir novamente", key=f"reemitir_pdi_{colaborador_id}_{periodo_sel}"):
                                with st.spinner("Consolidando o mês inteiro e emitindo o documento..."):
                                    plano = gerar_plano_desenvolvimento_mensal(periodo_sel, ficha_mensal, compilado, perfil_pdi, colaborador["nome"], colaborador["cargo"])
                                    salvar_pdi_emitido(
                                        colaborador_id, periodo_sel, resultado["nota_final"],
                                        ficha_mensal["media_parte_a"] if ficha_mensal else None,
                                        ficha_mensal["media_parte_b"] if ficha_mensal else None,
                                        compilado, plano, emitido_por=usuario["email"],
                                    )
                                st.success("PDI reemitido com sucesso.")
                                st.rerun()
                    else:
                        if st.button("Emitir PDI Corporativo", type="primary"):
                            with st.spinner("Consolidando o mês inteiro e emitindo o documento..."):
                                plano = gerar_plano_desenvolvimento_mensal(periodo_sel, ficha_mensal, compilado, perfil_pdi, colaborador["nome"], colaborador["cargo"])
                                salvar_pdi_emitido(
                                    colaborador_id, periodo_sel, resultado["nota_final"],
                            ...
                            st.success("PDI emitido com sucesso e disponibilizado no histórico do colaborador.")
                            st.rerun()
...
if papel == "RH":
    with abas[IDX["admin"]]:
        ...
        st.caption("A lista de Função/Nível abaixo é atualizada de acordo com a área escolhida aqui.")
        ...
        with st.form(f"form_prontuario_admin_{sufixo_key}"):
            ...
            cargo_pront = st.selectbox(
                ...
                key=f"pront_cargo_{sufixo_key}_{area_pront}",
            )
        ...
        papel_u = st.selectbox("Papel", options=["RH", "HEAD", "PRODUTOR", "COLABORADOR"], key="admin_papel_novo_usuario")

        area_u = None
        colaborador_u = None
        if papel_u == "HEAD":
            area_u = st.selectbox("Área sob responsabilidade", options=list(AREAS.keys()), format_func=lambda a: NOMES_AREAS.get(a, a), key="admin_area_novo_usuario")
            ...
            todos_colabs = [c for c in colabs_prontuario if c["ativo"]]
            if todos_colabs:
                mapa = {c["id"]: f"{c['nome']} — {c['cargo']}" for c in todos_colabs}
                colaborador_u = st.selectbox("Vincular ao prontuário de", options=list(mapa.keys()), format_func=lambda i: mapa[i], key="admin_colab_novo_usuario")
            else:
        ...
        with st.form("form_novo_usuario", clear_on_submit=True):
            ...
            st.caption(f"Papel selecionado: **{papel_u}**" + (f" — Área: **{NOMES_AREAS.get(area_u, area_u)}**" if area_u else ""))
        ...
        mapa_colabs = {c["id"]: c["nome"] for c in colabs_prontuario}
        linhas = []
        ...
        with st.expander("Redefinir senha de um usuário"):
            if usuarios_existentes:
                mapa_u_senha = {u["id"]: f"{u['nome']} ({u['email']})" for u in usuarios_existentes}
                alvo_senha = st.selectbox(
                    "Selecione o usuário para redefinir a senha", options=list(mapa_u_senha.keys()), format_func=lambda i: mapa_u_senha[i],
                    key="admin_reset_senha_sel",
                )
                nova_senha_admin = st.text_input("Nova senha para o usuário selecionado", type="password", key="admin_reset_senha_valor")
                if st.button("Redefinir senha", key="admin_reset_senha_botao"):
                    if not nova_senha_admin.strip():
                        st.error("Digite a nova senha.")
                    else:
                        atualizar_senha_usuario(alvo_senha, nova_senha_admin.strip())
                        st.success(f"Senha de {mapa_u_senha[alvo_senha]} atualizada. Avise a pessoa da nova senha por um canal seguro.")
            else:
                st.caption("Nenhum usuário cadastrado ainda.")

        with st.expander("Alterar e-mail de um usuário"):
            if usuarios_existentes:
                mapa_u_email = {u["id"]: f"{u['nome']} ({u['email']})" for u in usuarios_existentes}
                alvo_email = st.selectbox(
                    "Selecione o usuário para alterar o e-mail", options=list(mapa_u_email.keys()), format_func=lambda i: mapa_u_email[i],
                    key="admin_alterar_email_sel",
                )
                email_atual_selecionado = next((u["email"] for u in usuarios_existentes if u["id"] == alvo_email), "")
                novo_email_admin = st.text_input("Novo e-mail de login", value=email_atual_selecionado, key=f"admin_alterar_email_valor_{alvo_email}")
                if st.button("Salvar novo e-mail", key="admin_alterar_email_botao"):
                    if not novo_email_admin.strip() or "@" not in novo_email_admin:
                        st.error("Digite um e-mail válido.")
                    else:
                        try:
                            atualizar_email_usuario(alvo_email, novo_email_admin)
                            st.success(f"E-mail atualizado para {novo_email_admin.strip().lower()}. Avise a pessoa do novo e-mail de login.")
                            st.rerun()
                        except Exception as e:
                            st.error(f"Não foi possível atualizar (e-mail já usado por outra conta?). Detalhe: {e}")
            else:
                st.caption("Nenhum usuário cadastrado ainda.")
        ...
        st.divider()
        st.markdown("##### Excluir Avaliações ou Registro do Colaborador")
        st.caption("Zona de alta criticidade — exclusivo do RH/CEO. Ações irreversíveis.")

        colabs_para_excluir_aval = listar_colaboradores(incluir_inativos=True)
        if not colabs_para_excluir_aval:
            st.caption("Nenhum colaborador cadastrado ainda.")
        else:
            mapa_colabs_aval = {c["id"]: f"{c['nome']} — {c['cargo']}" for c in colabs_para_excluir_aval}
            colaborador_aval_id = st.selectbox(
                "Colaborador selecionado", options=list(mapa_colabs_aval.keys()), format_func=lambda i: mapa_colabs_aval[i],
                key="admin_excluir_aval_colab",
            )

            # Caixa de confirmação mestre (obrigatória para destravar qualquer botão)
            confirmar_exclusao_aval = st.checkbox(
                "Confirmo e assumo a responsabilidade pelas ações de exclusão sobre este colaborador.",
                key="admin_excluir_aval_confirma",
            )

            with st.popover("⚠️ EXCLUIR COLABORADOR DEFINITIVAMENTE"):
                st.error("ATENÇÃO: Isso apagará o profissional do banco de dados e removerá permanentemente TODO o histórico de avaliações técnicas e mensais dele para sempre.")
                usuario_vinculado = usuario_vinculado_a_colaborador(colaborador_aval_id)
                if usuario_vinculado:
                    st.warning(
                        f"Existe um login vinculado a este colaborador: **{usuario_vinculado['nome']}** "
                        f"({usuario_vinculado['email']}). Excluir o colaborador NÃO remove esse acesso — "
                        "ele continuará podendo entrar no sistema, só que sem nenhum perfil vinculado. "
                        "Recomendo remover esse usuário primeiro, na seção 'Remover usuário' logo acima."
                    )
                if st.button("Sim, apagar pessoa e histórico permanentemente", key=f"btn_excluir_definitivo_{colaborador_aval_id}", disabled=not confirmar_exclusao_aval, type="secondary"):
                    excluir_colaborador_definitivo(colaborador_aval_id)
                    st.success("O colaborador e todo o seu histórico foram removidos do sistema.")
                    st.rerun()

            st.write("")
            avaliacoes_campo_do_colab = listar_avaliacoes_campo(colaborador_id=colaborador_aval_id)
            avaliacoes_mensais_do_colab = listar_avaliacoes_mensais(colaborador_id=colaborador_aval_id)

            with st.expander(f"Avaliações de Entrega Técnica ({len(avaliacoes_campo_do_colab)})"):
                if not avaliacoes_campo_do_colab:
                    st.caption("Nenhuma Avaliação de Entrega Técnica lançada para este colaborador.")
                for a in avaliacoes_campo_do_colab:
                    col_info_aval, col_acao_aval = st.columns([4, 1])
                    with col_info_aval:
                        st.write(f"**{a['projeto']}** — {a['data_evento'].strftime('%d/%m/%Y')} — Média {a['media']:.2f}")
                    with col_acao_aval:
                        if st.button("Excluir", key=f"excluir_campo_{a['id']}", disabled=not confirmar_exclusao_aval):
                            excluir_avaliacao_campo(a["id"])
                            st.success("Avaliação de Entrega Técnica excluída.")
                            st.rerun()

            with st.expander(f"Avaliações de Competências e Cultura ({len(avaliacoes_mensais_do_colab)})"):
                if not avaliacoes_mensais_do_colab:
                    st.caption("Nenhuma ficha mensal lançada para este colaborador.")
                for m in avaliacoes_mensais_do_colab:
                    col_info_mensal, col_acao_mensal = st.columns([4, 1])
                    with col_info_mensal:
                        st.write(f"**{m['periodo']}** — Nota Final {m['nota_final_mensal']:.2f}")
                    with col_acao_mensal:
                        if st.button("Excluir", key=f"excluir_mensal_{m['id']}", disabled=not confirmar_exclusao_aval):
                            excluir_avaliacao_mensal(m["id"])
                            st.success("Avaliação de Competências e Cultura excluída.")
                            st.rerun()

        st.divider()
        st.subheader("Métricas e Inteligência de Equipes (Visão Macro)")
        st.caption("Visão estatística acumulada do perfil de talentos e domínios por setor da Firma Produções.")

        perfis_macros = listar_todos_perfis_consolidados()
        if not perfis_macros:
            st.caption("Ainda não há dados comportamentais suficientes coletados para gerar o relatório macro de RH.")
        else:
            df_macro_bruto = pd.DataFrame(perfis_macros)

            # 1. Distribuição Geral de Domínios por Área
            st.markdown("##### Distribuição de Domínios por Área da Firma")
            df_pivot = pd.crosstab(df_macro_bruto["area"], df_macro_bruto["dominio_principal"])
            df_porcentagem = (df_pivot.div(df_pivot.sum(axis=1), axis=0) * 100).round(1)
            df_porcentagem.index = [NOMES_AREAS.get(area, area) for area in df_porcentagem.index]
            df_porcentagem.columns.name = None
            df_exibicao_dominios = df_porcentagem.map(lambda v: f"{v}%" if v > 0 else "0%")
            df_exibicao_dominios = df_exibicao_dominios.reset_index().rename(columns={"index": "Área / Setor"})
            exibir_tabela(df_exibicao_dominios)

            # 2. Top 3 Forças e Gargalos de Desenvolvimento por Área
            st.markdown("##### Top 3 Forças e Gargalos por Área Funcional")
            linhas_talentos_macro = []
            for area_foco in df_macro_bruto["area"].unique():
                df_area_filtrada = df_macro_bruto[df_macro_bruto["area"] == area_foco]

                todos_talentos_area = [
                    item["talento"]
                    for lista_t in df_area_filtrada["top_talentos"]
                    for item in lista_t
                ]
                todas_oportunidades_area = [
                    talento
                    for lista_op in df_area_filtrada["pontos_desenvolvimento"]
                    for talento in lista_op
                ]

                forcas_top3 = pd.Series(todos_talentos_area).value_counts().head(3).index.tolist()
                gargalos_top3 = pd.Series(todas_oportunidades_area).value_counts().head(3).index.tolist()

                linhas_talentos_macro.append({
                    "Área / Setor": NOMES_AREAS.get(area_foco, area_foco),
                    "Top 3 Forças Mais Presentes": ", ".join(forcas_top3) if forcas_top3 else "—",
                    "Top 3 Oportunidades de Desenvolvimento": ", ".join(gargalos_top3) if gargalos_top3 else "—",
                })

            exibir_tabela(pd.DataFrame(linhas_talentos_macro))
