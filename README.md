...
- **Gatilho financeiro dos 70%** → nota consolidada ≥ 3.5 = ELEGÍVEL; abaixo disso, dispara alerta de PDI
...
2. **Motor de cálculo** — médias ponderadas, gatilho de 3.5, elegibilidade
   a promoção.
